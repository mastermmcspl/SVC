...
Partial Class VehicleMaintanance_VehOtherDashboard
    Inherits System.Web.UI.Page
    Private sFormName As String = "VehicleMaintanance/LgstLoanDashboard"
    ...
    Private Sub GetAmount()
        ...
        Try
            ...
            If dDebitAmt > dInsuranceAmt Then
                ...
                lblPaymentMasterValidationMsg.Text = "Add the Loan Amount of " & dBalanceAmt & " to vehicle." : lblError.Text = "Add the Loan Amount of " & dBalanceAmt & " to vehicle ."
    ...
    Public Sub BindSODetails(ByVal iPageIndex As Integer, ByVal iStatus As Integer)
        ...
        Try
            ...
            Else
                '  imgbtnWaiting.Visible = False : imgbtnDeActivate.Visible = False : imgbtnActivate.Visible = False
            End If
            dt = objvlm.LoadVehicleLoanDashDetails(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, iStatus)
    ...
    Private Sub GvVehicleMaster_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GvVehicleMaster.RowCommand
        ...
        Try
            ...
            If e.CommandName.Equals("Edit") Then
                ...
                End If
                oMasterID = HttpUtility.UrlEncode(objGen.EncryptQueryString(Val(lblDescID.Text)))
                Response.Redirect(String.Format("~/VehicleMaintanance/LgstLoanDetails.aspx?StatusID={0}&PID={1}", oStatusID, oMasterID), False) 'GeneralMasterDetails
            End If
    ...
    Private Sub lnkbtnExcel_Click(sender As Object, e As EventArgs) Handles lnkbtnExcel.Click
        ...
        Dim dt As New DataTable
        Try
            dt = objvlm.LoadVehicleLoanDashDetails(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, ddlStatus.SelectedIndex)
