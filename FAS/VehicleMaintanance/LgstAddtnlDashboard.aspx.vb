...
Partial Class VehicleMaintanance_VehicleAddDashboard
    Inherits System.Web.UI.Page
    Private sFormName As String = "VehicleMaintanance/LgstAddtnlDashboard"
    ...
    Private Sub GvVehicleMaster_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GvVehicleMaster.RowCommand
        ...
        Try
            ...
            If e.CommandName.Equals("Edit") Then
                ...
                End If
                oMasterID = HttpUtility.UrlEncode(objGen.EncryptQueryString(Val(lblDescID.Text)))
                Response.Redirect(String.Format("~/VehicleMaintanance/LgstAddtnlMaster.aspx?StatusID={0}&PID={1}", oStatusID, oMasterID), False) 'GeneralMasterDetails
            End If
    ...
    Private Sub imgbtnAdd_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnAdd.Click
        ...
        Try
            ...
            End If
            Response.Redirect(String.Format("~/VehicleMaintanance/LgstAddtnlMaster.aspx?StatusID={0}&PID={1}", oStatusID, oMasterName), False)
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
