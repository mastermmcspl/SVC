...
Partial Class VehicleMaintanance_LgstCostDtlsDashboard
    Inherits System.Web.UI.Page
    Private sFormName As String = "VehicleMaintanance/LgstCostDtlsDashboard"
    ...
    Public Sub BindSODetails(ByVal iPageIndex As Integer, ByVal iStatus As Integer)
        ...
        Try
            ...
            Else
                '  imgbtnWaiting.Visible = False : imgbtnDeActivate.Visible = False : imgbtnActivate.Visible = False
            End If
            dt = objvcd.LoadVehicleCostDashDetails(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, iStatus)
    ...
    Private Sub GvVehicleMaster_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GvVehicleMaster.RowCommand
        ...
        Try
            ...
            If e.CommandName.Equals("Edit") Then
                ...
                End If
                oMasterID = HttpUtility.UrlEncode(objGen.EncryptQueryString(Val(lblDescID.Text)))
                Response.Redirect(String.Format("~/VehicleMaintanance/LgstCostDtls.aspx?StatusID={0}&PID={1}", oStatusID, oMasterID), False) 'GeneralMasterDetails
            End If
    ...
    Private Sub imgbtnAdd_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnAdd.Click
        ...
        Try
            ...
            End If
            Response.Redirect(String.Format("~/VehicleMaintanance/LgstCostDtls.aspx?StatusID={0}&PID={1}", oStatusID, oMasterName), False)
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
    ...
    Private Sub lnkbtnExcel_Click(sender As Object, e As EventArgs) Handles lnkbtnExcel.Click
        ...
        Dim dt As New DataTable
        Try
            dt = objvcd.LoadVehicleCostDashDetails(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, ddlStatus.SelectedIndex)
