...
<%@ Page Language="VB" MasterPageFile="~/VehicleMaintanance.master" AutoEventWireup="false" CodeFile="LgstCostDtls.aspx.vb" Inherits="VehicleMaintanance_LgstCostDtls" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
        <div class="col-sm-4 col-md-4">
            <asp:Label runat="server" Text=" Total K.M Travel"></asp:Label>
            <asp:TextBox ID="txtKMTravel" runat="server" autocomplete="off" CssClass="aspxcontrols"></asp:TextBox>
           </div>
           <div class="col-sm-4 col-md-4">
            <asp:Label runat="server" Text=" Total Fuel Taken"></asp:Label>
            <asp:TextBox ID="txtTotFuel" runat="server" autocomplete="off" CssClass="aspxcontrols"></asp:TextBox>
           </div>
       <div class="col-sm-4 col-md-4">
            <asp:Label runat="server" Text=" Average Milage"></asp:Label>
            <asp:TextBox ID="txtMilage" runat="server" autocomplete="off" CssClass="aspxcontrols"></asp:TextBox>
           </div>
    </div>    
