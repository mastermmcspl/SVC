<%@ Page Title="" Language="VB" MasterPageFile="~/VehicleMaintanance.master" AutoEventWireup="false" CodeFile="LgstCostDtlsDashboard.aspx.vb" Inherits="VehicleMaintanance_LgstCostDtlsDashboard" %>
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-5 col-md-5 pull-left">
                <h2><b>Vehicle Operating Cost Details</b></h2>
            </div>
    ...
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="GvVehicleMaster" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                ...
                <asp:BoundField DataField="InvoiceNo" HeaderText="Invoice No" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="15%"></asp:BoundField>
                <asp:BoundField DataField="VehicleManufacturer" HeaderText="Vehicle Manufacturer" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="15%"></asp:BoundField>
