...
Imports System.Data
Imports System.IO
Partial Class DigitalFilling
    Inherits System.Web.UI.MasterPage
    Private Shared sFormName As String = "DigitalFilling Masterpage"
    ...
    Private Sub GetSubMenuOpen()
        Try
            liCabinet.Attributes.Remove("class") : liSubCabinet.Attributes.Remove("class") : liScan.Attributes.Remove("class")
    ...
    Private Sub GetClickedURL(ByVal sForm As String)
        Try
            ...
            ElseIf sForm = "NormalScan" Then
                ...
                Response.Redirect("~/DigitalFilling/NormalScan.aspx", False)
            ElseIf sForm = "Search" Then
                sSession.SubMenu = "Search" : sSession.Form = "Search"
    ...
    Protected Sub lnkbtnNormalScan_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkbtnNormalScan.Click
        ...
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkbtnNormalScan")
        End Try
    End Sub
    ...
    Protected Sub lnkSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkSearch.Click
        ...
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkSearch_Click")
        End Try
    End Sub
