...
Partial Class Accounts_ReceiptTransaction
    Inherits System.Web.UI.Page
    Private sFormName As String = "Accounts/ReceiptTransactions"
    Dim objGen As New clsFASGeneral
    Private objErrorClass As New BusinesLayer.Components.ErrorClass
    Private Shared sSession As AllSession
    Private objclsModulePermission As New clsModulePermission
    Dim objRecp As New clsReceipt
    Private Shared sRTAoD As String
    Private Shared sRTAP As String
    Private Shared sRTED As String
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If IsPostBack = False Then
                ...
                imgbtnDeActivate.Visible = False : sRTAoD = "NO" : sRTAP = "NO" : sRTED = "NO"
                ...
                'imgbtnReport.Visible = True
                BindReceiptDetails(0, ddlStatus.SelectedIndex, sSession.YearID)
            End If
    ...
    Public Sub BindReceiptDetails(ByVal iPageIndex As Integer, ByVal iStatus As Integer, ByVal iYearID As Integer)
        Try
            If ddlStatus.SelectedIndex = 0 Then
                If sRTAoD = "YES" Then
                    imgbtnDeActivate.Visible = True 'Activate
            ...
            dt = objRecp.LoadReceiptDashboard(sSession.AccessCode, sSession.AccessCodeID, iStatus, iYearID)
    ...
    Protected Sub chkSelectAll_CheckedChanged(sender As Object, e As EventArgs)
        ...
        Try
            ...
            If chkAll.Checked = True Then
                For iIndx = 0 To dgReceipt.Rows.Count - 1
                    chkField = dgReceipt.Rows(iIndx).FindControl("chkSelect")
        ...
        End Try
    End Sub
    Private Sub dgReceipt_PreRender(sender As Object, e As EventArgs) Handles dgReceipt.PreRender
        Try
            If dgReceipt.Rows.Count > 0 Then
                dgReceipt.UseAccessibleHeader = True
                dgReceipt.HeaderRow.TableSection = TableRowSection.TableHeader
                dgReceipt.FooterRow.TableSection = TableRowSection.TableFooter
            End If
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "dgReceipt_PreRender")
        End Try
    End Sub
    Private Sub dgReceipt_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles dgReceipt.RowDataBound
        ...
        Try
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                dgReceipt.Columns(0).Visible = True

                If ddlStatus.SelectedIndex = 0 Then
                    dgReceipt.Columns(8).Visible = False
                    If sRTAoD = "YES" Then
                        ' dgReceipt.Columns(8).Visible = True
                        dgReceipt.Columns(8).Visible = False
                    End If
            ...
            dgReceipt.Columns(9).Visible = False
            If sRTED = "YES" Then
                dgReceipt.Columns(9).Visible = True
            End If
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "dgReceipt_RowDataBound")
        End Try
    End Sub

    Private Sub dgReceipt_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles dgReceipt.RowCommand
        ...
        Try
            ...
            If e.CommandName.Equals("Edit") Then
                ...
                End If
                oMasterID = HttpUtility.UrlEncode(objGen.EncryptQueryString(Val(lblDescID.Text)))
                Response.Redirect(String.Format("~/Accounts/ReceiptTransactionDetails.aspx?StatusID={0}&MasterID={1}&MasterName={2}", oStatusID, oMasterID, oMasterName), False) 'GeneralMasterDetails
            End If
            If e.CommandName.Equals("Status") Then
                If ddlStatus.SelectedIndex = 0 Then
                    objRecp.UpdateReceiptStatus(sSession.AccessCode, sSession.AccessCodeID, lblDescID.Text, "D", sSession.UserID, sSession.IPAddress, sSession.YearID)
                ...
                End If
                If ddlStatus.SelectedIndex = 1 Then
                    objRecp.UpdateReceiptStatus(sSession.AccessCode, sSession.AccessCodeID, lblDescID.Text, "A", sSession.UserID, sSession.IPAddress, sSession.YearID)
                ...
                End If
                If ddlStatus.SelectedIndex = 2 Then
                    objRecp.UpdateReceiptStatus(sSession.AccessCode, sSession.AccessCodeID, lblDescID.Text, "W", sSession.UserID, sSession.IPAddress, sSession.YearID)
                    objRecp.WriteGLTable(sSession.AccessCode, sSession.AccessCodeID, lblDescID.Text, sSession.YearID, sSession.UserID)
                    'objRecp.CheckLedgerTable(sSession.AccessCode, sSession.AccessCodeID, lblDescID.Text, sSession.YearID, sSession.UserID, sSession.IPAddress)
        ...
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "dgReceipt_RowCommand")
        End Try
    End Sub
    ...
    Private Sub imgbtnAdd_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnAdd.Click
        ...
        Try
            ...
            End If
            Response.Redirect(String.Format("~/Accounts/ReceiptTransactionDetails.aspx?StatusID={0}&MasterName={1}", oStatusID, oMasterName), False)
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
    ...
    Private Sub dgReceipt_RowEditing(sender As Object, e As GridViewEditEventArgs) Handles dgReceipt.RowEditing
    ...
    Private Sub imgbtnActivate_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnActivate.Click
        ...
        Try
            ...
            For i = 0 To dgReceipt.Rows.Count - 1
                chkSelect = dgReceipt.Rows(i).FindControl("chkSelect")
...
NextSave:   For i = 0 To dgReceipt.Rows.Count - 1
                chkSelect = dgReceipt.Rows(i).FindControl("chkSelect")
                lblDescID = dgReceipt.Rows(i).FindControl("lblDescID")
                If chkSelect.Checked = True Then
                    objRecp.UpdateReceiptStatus(sSession.AccessCode, sSession.AccessCodeID, lblDescID.Text, "A", sSession.UserID, sSession.IPAddress, sSession.YearID)
                    lblError.Text = "Successfully Activated."
                    ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Popup", "swal('Successfully Activated','', 'success');", True)
...
NextSave:   For i = 0 To dgReceipt.Rows.Count - 1
    ...
    Private Sub lnkbtnPDF_Click(sender As Object, e As EventArgs) Handles lnkbtnPDF.Click
        ...
        Dim dt As New DataTable
        Try
            dt = objRecp.LoadReceiptDashboard(sSession.AccessCode, sSession.AccessCodeID, ddlStatus.SelectedIndex, sSession.YearID)
            If dt.Rows.Count = 0 Then
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rdlc/Accounts/rptReceiptTransaction.rdlc")
            Dim RptViewer As Byte() = ReportViewer1.LocalReport.Render("PDF")
            Response.Buffer = True
            Response.Clear()
            Response.ContentType = mimeType
            objclsGeneralFunctions.SaveGRACeFormOperations(sSession.AccessCode, sSession.AccessCodeID, sSession.UserID, "Masters", "Receipt Transaction", "PDF", sSession.YearID, sSession.YearName, 0, "", sSession.IPAddress)
            Response.AddHeader("content-disposition", "attachment; filename=ReceiptTransaction" + ".pdf")
    ...
    Private Sub lnkbtnExcel_Click(sender As Object, e As EventArgs) Handles lnkbtnExcel.Click
        ...
        Try
            ...
            Response.Clear()
            Response.ContentType = mimeType
            objclsGeneralFunctions.SaveGRACeFormOperations(sSession.AccessCode, sSession.AccessCodeID, sSession.UserID, "Masters", "Receipt Transaction", "Excel", sSession.YearID, sSession.YearName, 0, "", sSession.IPAddress)
            Response.AddHeader("content-disposition", "attachment; filename=ReceiptTransaction" + ".xls")
            Response.BinaryWrite(RptViewer)
            Response.Flush()
            Response.End()
        Catch ex As Exception
