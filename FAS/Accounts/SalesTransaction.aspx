<%@ Page Title="" Language="VB" MasterPageFile="~/Accounts.master" AutoEventWireup="false" CodeFile="SalesTransaction.aspx.vb" Inherits="Accounts_SalesTransaction" %>
   ...
   <%-- <cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></cc1:ToolkitScriptManager>--%>
    ...
    <script lang="javascript" type="text/javascript">
        ...
        function CalculateGrandDiscount() {
         if (document.getElementById('<%=txtTradeDis.ClientID %>').value != "") {
             var ssDiscount = parseFloat((parseFloat(document.getElementById('<%=txtAmount.ClientID %>').value) * parseFloat(document.getElementById('<%=txtTradeDis.ClientID %>').value)) / 100).toFixed(2)
               document.getElementById('<%=txtTradeDiscountAmt.ClientID %>').value = ssDiscount
               document.getElementById('<%=txtTotalNetAmt.ClientID %>').value = parseFloat(parseFloat(document.getElementById('<%=txtAmount.ClientID %>').value) - parseFloat(ssDiscount)).toFixed(2)
           }
           else {
               document.getElementById('<%=txtTradeDiscountAmt.ClientID %>').value = 0
               document.getElementById('<%=txtTotalNetAmt.ClientID %>').value = parseFloat(document.getElementById('<%=txtAmount.ClientID %>').value)
           }
        ...
        function BasicAmt() {
         if (document.getElementById('<%=txtAmount.ClientID %>').value != "") {             
             ...
             document.getElementById('<%=txtTotalNetAmt.ClientID %>').value = ""
             document.getElementById('<%=txtTradeDis.ClientID %>').value = ""
             document.getElementById('<%=txtTradeDiscountAmt.ClientID %>').value = ""
           }

        }

        function Calculate() {
         if (document.getElementById('<%=txtTradeDiscountAmt.ClientID %>').value != "") {
               document.getElementById('<%=txtTradeDis.ClientID %>').value = 0
               document.getElementById('<%=txtTotalNetAmt.ClientID %>').value = parseFloat(parseFloat(document.getElementById('<%=txtAmount.ClientID %>').value) - parseFloat(document.getElementById('<%=txtTradeDiscountAmt.ClientID %>').value)).toFixed(2)
           }
           else {
               document.getElementById('<%=txtTradeDiscountAmt.ClientID %>').value = 0
               document.getElementById('<%=txtTotalNetAmt.ClientID %>').value = parseFloat(document.getElementById('<%=txtAmount.ClientID %>').value)
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-9 col-md-9 pull-left">
                <h2><b>Sales Transaction Details</b> </h2>
            </div>
    ...
    <div class="col-sm-12 col-md-12 divmargin" style="padding: 0px">
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            <div class="col-sm-3 col-md-3">
                <asp:Label runat="server" Text="Existing Sales Voucher"></asp:Label>
            ...
            <div class="col-sm-3 col-md-3">
                <asp:Label runat="server" Text="Receipt Date" Visible="false"></asp:Label>
               <%-- <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVReceiptDate" runat="server" ControlToValidate="txtReceiptDate" Display="Dynamic" SetFocusOnError="True"
                    ErrorMessage="Enter Receipt Date." ValidationGroup="Validate"></asp:RequiredFieldValidator>
                ...
                <asp:TextBox ID="txtReceiptDate" runat="server" CssClass="aspxcontrols" placeholder="dd/MM/yyyy" Visible="false"></asp:TextBox>
        ...
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            ...
            <div class="col-sm-2 col-md-2">
                <asp:Label runat="server" Text="* Charge Amount"></asp:Label>
            ...
            <div class="col-sm-2 col-md-2">
                ...
                <asp:TextBox ID="txtOtherCharge" runat="server" CssClass="aspxcontrolsdisable" AutoPostBack="true" Visible="false"></asp:TextBox>
            ...
            <div class="col-sm-2 col-md-2">
                ...
                <asp:TextBox ID="txtPaidAmount" runat="server" CssClass="aspxcontrols" AutoPostBack="true" ReadOnly="true" Visible="false"></asp:TextBox>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            ...
            <div class="col-sm-3 col-md-3">
                ...
                <asp:TextBox ID="txtDeleveryAddress" runat="server" CssClass="aspxcontrols" TextMode="MultiLine" Height="50px"></asp:TextBox>
                 <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVDeleveryAddress" runat="server" ControlToValidate="txtDeleveryAddress" Display="Dynamic" SetFocusOnError="True" ErrorMessage="Enter Shipp To Address" ValidationGroup="Validate"></asp:RequiredFieldValidator>
                <%--<asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVDeleveryAddress" runat="server" ControlToValidate="txtDeleveryAddress" Display="Dynamic" SetFocusOnError="True" ErrorMessage="Enter Delivery Address" ValidationGroup="ValidateAdd"></asp:RequiredFieldValidator>--%>
            </div>
        </div>
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            ...
            <div class="col-sm-3 col-md-3">
                ...
                <%--<asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVDeliveryGSTNRegNo" runat="server" ControlToValidate="txtDeliveryGSTNRegNo" Display="Dynamic" SetFocusOnError="True" ErrorMessage="Enter Shipp To GSTN Reg.No" ValidationGroup="Validate"></asp:RequiredFieldValidator>--%>
                <%-- <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVDeliveryPinCode" runat="server" ControlToValidate="txtDeliveryPinCode" Display="Dynamic" SetFocusOnError="True" ErrorMessage="Enter Delivery PinCode" ValidationGroup="ValidateAdd"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="REVDeliveryPinCode" runat="server" ControlToValidate="txtDeliveryPinCode" Display="Dynamic" ErrorMessage="Enter Valid Delivery PinCode" SetFocusOnError="True" ValidationExpression="^[0-9\s]{1,6}$"></asp:RegularExpressionValidator>--%>
            </div>
        </div>
    ...
    <div class="col-sm-12 col-md-12">
        <asp:DataGrid ID="dgItems" runat="server" AutoGenerateColumns="False" AllowPaging="False" Width="100%" class="footable">
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="Commodity" HeaderText="Commodity">
                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Left" VerticalAlign="Top" Width="20px" />
                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Left" VerticalAlign="Top" />
                </asp:BoundColumn>
        ...
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="col-sm-1 col-md-1">
                        <asp:Label ID="lblAmount" Text="* BasicAmt" runat="server" Visible ="false" ></asp:Label>
                        <asp:TextBox ID="txtAmount" runat="server" CssClass="aspxcontrols" Visible ="false"></asp:TextBox>
                        <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVAmount" runat="server" ControlToValidate="txtAmount" Display="Dynamic" SetFocusOnError="True"
                            ErrorMessage="Enter Amount." ValidationGroup="AddbtnValidate"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="REVAmount" runat="server" ControlToValidate="txtAmount" Display="Dynamic"
                            SetFocusOnError="True" ValidationGroup="AddbtnValidate"></asp:RegularExpressionValidator>
                    </div>

                    <div class="col-sm-1 col-md-1">
                        <asp:Label ID="Label3" Text="TradeDis%" runat="server" Visible ="false"></asp:Label>
                        <asp:TextBox ID="txtTradeDis" runat="server" CssClass="aspxcontrols" AutoPostBack="true" Visible ="false" ></asp:TextBox>
                        <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVTradeDis" runat="server" ControlToValidate="txtTradeDis" Display="Dynamic" SetFocusOnError="True"
                            ErrorMessage="Enter Amount." ValidationGroup="AddbtnValidate"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="REVTradeDis" runat="server" ControlToValidate="txtTradeDis" Display="Dynamic"
                            SetFocusOnError="True" ValidationGroup="AddbtnValidate"></asp:RegularExpressionValidator>
                    </div>

                    <div class="col-sm-2 col-md-2">
                        <asp:Label ID="Label1" Text="* Trade Disount Amt" runat="server" Visible ="false"></asp:Label>
                        <asp:TextBox ID="txtTradeDiscountAmt" runat="server" CssClass="aspxcontrols" AutoPostBack="true" Visible ="false"></asp:TextBox>
                        <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVTradeDiscountAmt" runat="server" ControlToValidate="txtTradeDiscountAmt" Display="Dynamic" SetFocusOnError="True"
                            ErrorMessage="Enter Amount." ValidationGroup="AddbtnValidate"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="REVTradeDiscountAmt" runat="server" ControlToValidate="txtTradeDiscountAmt" Display="Dynamic"
                            SetFocusOnError="True" ValidationGroup="AddbtnValidate"></asp:RegularExpressionValidator>
                    </div>

                    <div class="col-sm-1 col-md-1">
                        <asp:Label ID="Label2" Text="* Amount" runat="server" Visible ="false"></asp:Label>
                        <asp:TextBox ID="txtTotalNetAmt" runat="server" CssClass="aspxcontrols" AutoPostBack="true" Visible ="false"></asp:TextBox>
                        <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVTotalAmt" runat="server" ControlToValidate="txtTotalNetAmt" Display="Dynamic" SetFocusOnError="True"
                            ErrorMessage="Enter Amount." ValidationGroup="AddbtnValidate"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="REVTotalAmt" runat="server" ControlToValidate="txtTotalNetAmt" Display="Dynamic"
                            SetFocusOnError="True" ValidationGroup="AddbtnValidate"></asp:RegularExpressionValidator>
                    </div>

                    <div class="col-sm-1 col-md-1">
                        <asp:Label runat="server" Text="* TaxType" Visible ="false"></asp:Label>
                        <asp:DropDownList ID="ddlTaxType" runat="server" CssClass="aspxcontrols" AutoPostBack="True" Visible ="false">
                        </asp:DropDownList>
                        <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVTaxType" runat="server" ControlToValidate="ddlTaxType" Display="Dynamic" SetFocusOnError="True"
                            ErrorMessage="Select Tax Type" ValidationGroup="AddbtnValidate"></asp:RequiredFieldValidator>
                    </div>

                    <div class="col-sm-2 col-md-2">
                        <asp:Label runat="server" Text="* TaxRate" Visible ="false"></asp:Label>
                        <asp:DropDownList ID="ddlTaxRate" runat="server" CssClass="aspxcontrols" AutoPostBack="True" Visible ="false">
                        </asp:DropDownList>
                    </div>

                    <div class="col-sm-1 col-md-1">
                        <asp:Label runat="server" Text="* TaxAmt" Visible ="false"></asp:Label>
                        <asp:TextBox ID="txtTaxAmount" runat="server" CssClass="aspxcontrols" ReadOnly="true" Visible ="false"></asp:TextBox>
                    </div>

                    <div class="col-sm-2 col-md-2">
                        <asp:Label runat="server" Text="* TotalAmt" Visible ="false"></asp:Label>
                        <asp:TextBox ID="txtTotal" runat="server" CssClass="aspxcontrols" ReadOnly="true" Visible ="false"></asp:TextBox>
                    </div>
            ...
            <div class="col-sm-1 col-md-1">
                <asp:Button ID="btnAddTax" runat="server" CssClass="btn-ok" Text="Add" ValidationGroup="AddbtnValidate" Visible ="false"></asp:Button>
            </div>
        </div>

        <div class="col-sm-12 col-md-12">
            <asp:DataGrid ID="dgSales" runat="server" AutoGenerateColumns="False" AllowPaging="False" Width="100%" class="footable" Visible ="false">
                <HeaderStyle Font-Bold="true" BackColor="#e5e5e5" />
                <PagerStyle CssClass="gripagination" Mode="NumericPages" />
                <Columns>
