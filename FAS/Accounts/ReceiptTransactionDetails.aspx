<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Accounts.master" CodeFile="ReceiptTransactionDetails.aspx.vb" Inherits="Accounts_ReceiptTransactionDetails" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-9 col-md-9 pull-left">
                <h2><b>Receipt Transaction Details</b> </h2>
            </div>
            <div class="col-sm-3 col-md-3">
                <div class="pull-right">
                    ...
                    <asp:ImageButton ID="imgbtnSave" CssClass="activeIcons hvr-bounce-out" runat="server" data-toggle="tooltip" data-placement="bottom" title="Save" CausesValidation="false" ValidationGroup="Validate" />
                    ...
                    <asp:ImageButton ID="imgbtnUpdate" CssClass="activeIcons hvr-bounce-out" runat="server" data-toggle="tooltip" data-placement="bottom" title="Update" CausesValidation="false" ValidationGroup="Validate" />
                    ...
                    <ul class="nav navbar-nav navbar-right logoutDropdown">
                        <li class="dropdown">
                            <a href="#" data-toggle="dropdown" style="padding: 0px;"><span>
                                <img class="dropdown-toggle hvr-bounce-out" id="imgbtnReport" runat="server" data-toggle="tooltip" data-placement="top" /></span></a>
    ...
    <div class="col-sm-12 col-md-12 divmargin" style="padding: 0px">
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            <div class="col-sm-3 col-md-3">
                <asp:Label runat="server" Text="Existing Receipt Voucher"></asp:Label>
                <asp:DropDownList ID="ddlExistReceipt" runat="server" CssClass="aspxcontrols" AutoPostBack="true"></asp:DropDownList>
            </div>

            <div class="col-sm-3 col-md-3">
                <asp:Label runat="server" Text="* Date of Receipt"></asp:Label>
                <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVInvoiceDate" runat="server" ControlToValidate="txtInvoiceDate" Display="Dynamic" SetFocusOnError="True"
                    ErrorMessage="Enter Invoice Date." ValidationGroup="Validate"></asp:RequiredFieldValidator>
             ...
             <div class="col-sm-3 col-md-3">
                <asp:Label runat="server" Text="Receipt Type"></asp:Label>
        ...
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            ...
            <div class="col-sm-3 col-md-3">
                <asp:Label runat="server" Text="* Receipt Voucher Type"></asp:Label>
                <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVBillType" runat="server" ControlToValidate="ddlBillType" Display="Dynamic" SetFocusOnError="True"
                    ErrorMessage="Select Receipt Voucher Type." ValidationGroup="Validate"></asp:RequiredFieldValidator>
        ...
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            ...
            <div class="col-sm-2 col-md-2">
                ...
                <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="RFVEPaidAmount" runat="server" ControlToValidate="txtPaidAmount" Display="Dynamic"
                    SetFocusOnError="True" ValidationGroup="Validate"></asp:RegularExpressionValidator>
                <asp:TextBox ID="txtPaidAmount" runat="server" CssClass="aspxcontrols" AutoPostBack="true"></asp:TextBox>
            </div>
        </div>
        ...
        <%--<div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            <div class="col-sm-3 col-md-3">
                ...
                <div class="form-group">
                    <asp:TextBox ID="txtInvoice" runat="server" CssClass="aspxcontrols" Width="85%"></asp:TextBox>
                </div>
            </div>
            <div class="col-sm-2 col-md-2">
                <asp:Label ID="lblInvDate" runat="server" Text="Invoice Date"></asp:Label>
                <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="REVtxtInvDate" runat="server" ControlToValidate="txtInvDate" Display="Dynamic"
                    SetFocusOnError="True" ValidationGroup="Validate"></asp:RegularExpressionValidator>
                <asp:TextBox ID="txtInvDate" runat="server" CssClass="aspxcontrols" placeholder="dd/MM/yyyy"></asp:TextBox>
                <cc1:CalendarExtender ID="CalendarExtender_txtInvDate" runat="server" PopupButtonID="txtInvDate" PopupPosition="BottomLeft"
                    TargetControlID="txtInvDate" Format="dd/MM/yyyy" CssClass="cal_Theme1">
                </cc1:CalendarExtender>
               
            </div>
            <div class="col-sm-2 col-md-2">
                <asp:Label ID="lblInvAmount" runat="server" Text="Invoice Amount"></asp:Label>
                <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="REVtxtInvAmount" runat="server" ControlToValidate="txtInvAmount" Display="Dynamic"
                    SetFocusOnError="True" ValidationGroup="Validate"></asp:RegularExpressionValidator>
                <asp:TextBox ID="txtInvAmount" runat="server" AutoPostBack ="true" CssClass="aspxcontrols"></asp:TextBox>
            </div>
        </div>--%>
         <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
             <div class="col-sm-3 col-md-3">
            ...
            <div class="col-sm-3 col-md-3">
                <asp:Label runat="server" ID="lblFEAmt" Text="* FE Amount" Visible="false"></asp:Label>
            ...
            <div class="col-sm-3 col-md-3">
                ...
                <asp:TextBox ID="txtDiffAmount" runat="server" CssClass="aspxcontrolsdisable" Visible="false"></asp:TextBox>
            </div>
            <div class="col-sm-3 col-md-3">
                <br />
        ...
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            <div class="col-sm-3 col-md-3">
                ...
                <div class="form-group">
                    ...
                    <asp:ImageButton ID="imgbtnSearch" CssClass="activeIcons hvr-bounce-out" runat="server" data-toggle="tooltip" data-placement="bottom" title="Add New" />
                </div>
            </div>
            <div class="col-sm-2 col-md-2">
                <asp:Label ID="lblBillDate" runat="server" Text="Invoice Date"></asp:Label>
            ...
            <div class="col-sm-2 col-md-2">
                <asp:Label ID="lblBillAmount" runat="server" Text="Invoice Amount"></asp:Label>
        ...
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            <div class="col-sm-3 col-md-3">
                <asp:Label ID ="lblOrderNo" runat="server" Text="Existing Sales Order No." ></asp:Label>               
        ...
        <div id="collapseBill" class="collapse">
            <div class="col-sm-11 col-md-11 form-group" style="padding: 0px">
                <asp:GridView ID="GVReceipt" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
                    <Columns>
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="2%">
                            <ItemTemplate>
                                <asp:CheckBox ID="chkSelectBox" runat="server" CssClass="aspxradiobutton hvr-bounce-in" />
                                <asp:Label ID="lblBillID" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.SMID") %>'></asp:Label>
                                <asp:Label ID="lblBillName" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.BillNo") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="SMID" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblSMID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "SMID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <div class="col-sm-9 col-md-9" style="padding: 0px">
                <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="col-sm-3 col-md-3">
                                ...
                                <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVddlDBOtherHead" runat="server" ControlToValidate="ddlDBOtherHead" Display="Dynamic" SetFocusOnError="True"
                            ErrorMessage="Select Head of Accounts" ValidationGroup="ValidateDBAdd"></asp:RequiredFieldValidator>
                                <asp:DropDownList ID="ddlDBOtherHead" runat="server" CssClass="aspxcontrols" AutoPostBack="true">
                                </asp:DropDownList>
                            </div>
                            <div class="col-sm-3 col-md-3">
                            ...
                            <div class="col-sm-2 col-md-2">
                                ...
                                <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVtxtOtherDebit" runat="server" ControlToValidate="txtOtherDebit" Display="Dynamic" SetFocusOnError="True"
                            ErrorMessage="Enter Amount" ValidationGroup="ValidateDBAdd"></asp:RequiredFieldValidator>
                                <asp:TextBox ID="txtOtherDebit" runat="server" CssClass="aspxcontrols"></asp:TextBox>
                            </div>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="ddlDBOtherHead" EventName="SelectedIndexChanged" />
                    ...
                    <div class="col-sm-1 col-md-1">
                        <asp:ImageButton ID="btnAddDebit" CssClass="activeIcons hvr-bounce-out" runat="server" data-toggle="tooltip" data-placement="bottom" title="Add New" ValidationGroup="ValidateDBAdd" />
                    </div>
                </div>
                <div class="col-sm-12 col-md-12" style="padding: 0px">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="col-sm-2 col-md-2">
                                <asp:Label runat="server" Text="Amount"></asp:Label>
                                <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVtxtOtherCredit" runat="server" ControlToValidate="txtOtherCredit" Display="Dynamic" SetFocusOnError="True"
                                    ErrorMessage="Enter Amount" ValidationGroup="ValidateCRAdd"></asp:RequiredFieldValidator>
                                <asp:TextBox ID="txtOtherCredit" runat="server" CssClass="aspxcontrols"></asp:TextBox>
                            </div>
                        </ContentTemplate>
                        <Triggers>
                    ...
                    <div class="col-sm-1 col-md-1">
                        <asp:ImageButton ID="btnAddCredit" CssClass="activeIcons hvr-bounce-out" runat="server" data-toggle="tooltip" data-placement="bottom" title="Add New" ValidationGroup ="ValidateCRAdd" />
                    </div>
                </div>
            </div>
             <div class="col-sm-3 col-md-3">
   ...
   <%-- </div>--%>
    ...
    <div class="col-md-12">
        <div id="divcollapseChequeDetails" runat="server" visible="false" data-toggle="collapse" data-target="#collapseChequeDetails"><a href="#"><b><i>Click here to Enter Cheque Details...</i></b></a></div>
    </div>
    <div class="col-md-12" style="padding-left: 0px">
     ...
     <div class="col-md-12">
        <div id="divcollapseFundDetails" runat="server" visible="false" data-toggle="collapse" data-target="#collapseFundDetails"><a href="#"><b><i>Click here to Enter Fund Transfer Details...</i></b></a></div>
    </div>
    <div class="col-md-12" style="padding-left: 0px">
        <div id="collapseFundDetails" class="collapse">
            <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
                <div class="col-sm-4 col-md-4">
                    <asp:Label runat="server" Text="Fund Transfer No."></asp:Label>
                   <%-- <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtFundTransferNo" Display="Dynamic"
                        SetFocusOnError="True" ValidationGroup="Validate"></asp:RegularExpressionValidator>--%>
                ...
                <div class="col-sm-4 col-md-4">
                    ...
                    <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="REFFundDate" runat="server" ControlToValidate="txtFundTransferDate" Display="Dynamic"
                        SetFocusOnError="True" ValidationGroup="Validate"></asp:RegularExpressionValidator>
                    <asp:TextBox ID="txtFundTransferDate" runat="server" autocomplete="off" CssClass="aspxcontrols"></asp:TextBox>
    ...
    <div class="col-md-12">
        <div id="divcollapseChallenDetails" runat="server" visible="false" data-toggle="collapse" data-target="#collapseChallenDetails"><a href="#"><b><i>Click here to Enter Challen Details...</i></b></a></div>
    </div>
    <div class="col-md-12" style="padding-left: 0px">
        <div id="collapseChallenDetails" class="collapse">
            <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
                <div class="col-sm-4 col-md-4">
                    <asp:Label runat="server" Text="Challen No."></asp:Label>
                   <%-- <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtChallenNo" Display="Dynamic"
                        SetFocusOnError="True" ValidationGroup="Validate"></asp:RegularExpressionValidator>--%>
                    <asp:TextBox ID="txtChallenNo" runat="server" autocomplete="off" CssClass="aspxcontrols"></asp:TextBox>
                </div>
                <div class="col-sm-4 col-md-4">
                    <asp:Label runat="server" Text="Challen Date"></asp:Label>
                    <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="REFChallenDate" runat="server" ControlToValidate="txtChallenDate" Display="Dynamic"
                        SetFocusOnError="True" ValidationGroup="Validate"></asp:RegularExpressionValidator>
                    <asp:TextBox ID="txtChallenDate" runat="server" autocomplete="off" CssClass="aspxcontrols"></asp:TextBox>
                    <cc1:CalendarExtender ID="CalendarExtender3" runat="server" PopupButtonID="txtChallenDate" PopupPosition="BottomLeft"
                        TargetControlID="txtChallenDate" Format="dd/MM/yyyy" CssClass="cal_Theme1">
                    </cc1:CalendarExtender>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-12 col-md-12">
        <asp:DataGrid ID="dgReceiptDetails" runat="server" AutoGenerateColumns="False" AllowPaging="false" PageSize="20" Width="100%" class="footable">
            ...
            <Columns>
                ...
                <asp:TemplateColumn >
                    <ItemTemplate>
                        <asp:ImageButton ID="imgbtnDelete" CssClass="hvr-bounce-in" data-toggle="tooltip" CommandName="Delete" title="Delete" data-placement="bottom" runat="server" />
                    </ItemTemplate>
                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Left" VerticalAlign="Top" Width="10%" />
    ...
    <div class="col-sm-12 col-md-12 form-group">
        <asp:TextBox ID="txtBillIDs" runat="server" Visible="false"></asp:TextBox>
    </div>
