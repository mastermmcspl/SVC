<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Accounts.master" CodeFile="ReceiptTransaction.aspx.vb" Inherits="Accounts_ReceiptTransaction" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-3 col-md-3 pull-left">
                <h2><b>1.6 Receipt Transaction</b></h2>
            </div>
    ...
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgReceipt" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                ...
                <asp:BoundField DataField="ID" HeaderText="ID" Visible="false" HeaderStyle-Width="3%"></asp:BoundField>
                ...
                <asp:BoundField DataField="Party" HeaderText="Customer" HeaderStyle-Width="35%"></asp:BoundField>
                <asp:BoundField DataField="BillType" HeaderText="Voucher Type" HeaderStyle-Width="15%"></asp:BoundField>
