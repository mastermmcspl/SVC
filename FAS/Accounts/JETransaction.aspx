<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Accounts.master" CodeFile="JETransaction.aspx.vb" Inherits="Accounts_JETransaction" ValidateRequest="false" %>
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-4 col-md-4 pull-left">
                <h2><b>1.7 Journal Entry Transaction</b></h2>
            </div>
    ...
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgJE" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                ...
                <asp:BoundField DataField="BillNo" HeaderText="Bill No" HeaderStyle-Width="10%"></asp:BoundField>
                ...
                <asp:BoundField DataField="BillType" HeaderText="Bill Type" HeaderStyle-Width="10%"></asp:BoundField>
