<%@ Page Title="" Language="VB" MasterPageFile="~/Accounts.master" AutoEventWireup="false" CodeFile="PurchaseSalesJE.aspx.vb" Inherits="Accounts_PurchaseSalesJE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-5 col-md-5 pull-left">
                <h2><b>Purchase & Sales JE Transaction</b></h2>
            </div>
          
            <div class="col-sm-7 col-md-7">
                <div class="pull-right">
                    <asp:ImageButton ID="imgbtnAdd" CssClass="activeIcons hvr-bounce-out" runat="server" data-toggle="tooltip" data-placement="bottom" title="" Visible="false" />
                    <asp:ImageButton ID="imgbtnActivate" CssClass="activeIcons hvr-bounce-out" runat="server" data-toggle="tooltip" data-placement="bottom" title="Activate" Visible="false" />
                    ...
                    <asp:ImageButton ID="imgbtnWaiting" CssClass="activeIcons hvr-bounce-out" runat="server" data-toggle="tooltip" data-placement="bottom" title="Approve" Visible="false"/>
    ...
    <div class="col-sm-12 col-md-12" style="padding-left: 0px">
        ...
        <div class="col-sm-4 col-md-4 divmargin" style="padding-left: 0px">
            ...
            <asp:DropDownList ID="ddlPS" runat="server" AutoPostBack="true" CssClass="aspxcontrols" Width="275px">
   ...
   <div class="clearfix divmargin"></div>
    <div class="col-sm-12 col-md-12 form-group">
        <fieldset>
            <asp:Label ID="lblSI" runat="server" class="legendbold"></asp:Label>
        </fieldset>
    </div>
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgJE" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                ...
                <asp:BoundField DataField="TransactionNo" HeaderText="Transaction No" HeaderStyle-Width="13%"></asp:BoundField>
                <asp:BoundField DataField="BillNo" HeaderText="Bill No" HeaderStyle-Width="20%"></asp:BoundField>
                ...
                <asp:BoundField DataField="BillType" HeaderText="Bill Type" HeaderStyle-Width="20%" Visible="false"></asp:BoundField>
                <asp:BoundField DataField="Status" HeaderText="Status" HeaderStyle-Width="20%"></asp:BoundField>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton ID="imgbtnStatus" CssClass="hvr-bounce-in" CommandName="Status" runat="server" Visible ="false"  />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <ItemTemplate>
    ...
    <div class="col-sm-12 col-md-12 form-group">
        <fieldset>
            <asp:Label ID="lblSRJE" runat="server" class="legendbold"></asp:Label>
        </fieldset>
    </div>
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgJESR" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                        <asp:CheckBox ID="chkSelectAll" runat="server" AutoPostBack="True" CssClass="aspxradiobutton hvr-bounce-in" OnCheckedChanged="chkSelectAllSR_CheckedChanged" />
                    </HeaderTemplate>
                    <ItemTemplate>
                        <asp:CheckBox ID="chkSelect" runat="server" CssClass="aspxradiobutton hvr-bounce-in" />
                        <asp:Label ID="lblDescID" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ID") %>'></asp:Label>
    ...
    <div class="col-sm-12 col-md-12 form-group">
        <fieldset>
            <asp:Label ID="lblCSJE" runat="server" class="legendbold"></asp:Label>
        </fieldset>
    </div>
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgJECS" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                        <asp:CheckBox ID="chkSelectAll" runat="server" AutoPostBack="True" CssClass="aspxradiobutton hvr-bounce-in" OnCheckedChanged="chkSelectAllCS_CheckedChanged" />
                    </HeaderTemplate>
                    <ItemTemplate>
                        <asp:CheckBox ID="chkSelect" runat="server" CssClass="aspxradiobutton hvr-bounce-in" />
                        <asp:Label ID="lblDescID" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ID") %>'></asp:Label>
