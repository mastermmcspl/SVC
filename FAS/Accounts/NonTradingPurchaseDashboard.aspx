<%@ Page Title="" Language="VB" MasterPageFile="~/Accounts.master" AutoEventWireup="false" CodeFile="NonTradingPurchaseDashboard.aspx.vb" Inherits="Accounts_NonTradingPurchaseDashboard" %>
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-5 col-md-5 pull-left">
                <h2><b>Non Trading Purchase Transaction DashBoard</b></h2>
            </div>
    ...
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgPurchase" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                        <asp:CheckBox ID="chkSelectAll" runat="server" AutoPostBack="True" CssClass="aspxradiobutton hvr-bounce-in" Visible ="false" />
                    </HeaderTemplate>
                    <ItemTemplate>
                        <asp:CheckBox ID="chkSelect" runat="server" CssClass="aspxradiobutton hvr-bounce-in" Visible ="false"  />
