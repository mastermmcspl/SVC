<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Accounts.master" CodeFile="PaymentTransaction.aspx.vb" Inherits="Accounts_PaymentTransaction" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-3 col-md-3 pull-left">
                <h2><b>1.4 Payment Transaction</b></h2>
            </div>
            ...
            <div class="col-sm-9 col-md-9">
                <div class="pull-right">
                    ...
                    <asp:ImageButton ID="imgbtnWaiting" CssClass="activeIcons hvr-bounce-out" runat="server" data-toggle="tooltip" data-placement="bottom" title="Approve" />
                     <asp:ImageButton ID="ImgBtnRecall" CssClass="activeIcons hvr-bounce-out" runat="server" data-toggle="tooltip" data-placement="bottom" title="Recall" Visible="false" />
    ...
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgPayment" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                ...
                <asp:BoundField DataField="BillType" HeaderText="Bill Type" HeaderStyle-Width="15%"></asp:BoundField>
    ...
    <div id="ModalPaymentValidation" class="modalmsg fade" data-backdrop="static" data-keyboard="false" role="dialog">
     ...
     <div id="myModalRecallBtn" class="modalmsg fade" data-backdrop="static" data-keyboard="false" role="dialog">
        <div class="modalmsg-dialog">
            <div class="modalmsg-content">
                <div class="modalmsg-header">
                ...
                <div class="modalmsg-body">
                    <div id="divMsgRecall" class="alert alert-info">
                        <p>
                            <strong>
                                   <asp:Label ID="lblRecall" runat="server"></asp:Label>
                            </strong>
                        </p>
                ...
                <div class="modalmsg-footer">
                    <asp:Button runat="server" Text="Yes" class="btn-ok" ID="BtnRecallOK"></asp:Button>
                    <asp:Button runat="server" Text="No" class="btn-ok" ID="BtnRecallCancel"></asp:Button>
                </div>
            </div>
        </div>
    </div>
