<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Accounts.master" CodeFile="PettyCashTransaction.aspx.vb" Inherits="Accounts_PettyCashTransaction" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script lang="javascript" type="text/javascript">
        $(document).ready(function () {
            ...
            $('#<%=dgPettyCash.ClientID%>').DataTable({
                iDisplayLength: 20,
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-4 col-md-4 pull-left">
                <h2><b>1.5 Petty Cash Transaction</b></h2>
            </div>
    ...
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgPettyCash" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                ...
                <asp:BoundField DataField="TransactionNo" HeaderText="VoucherNo" HeaderStyle-Width="10%"></asp:BoundField>
                ...
                <asp:BoundField DataField="BillAmount" HeaderText="Bill Amt" HeaderStyle-Width="10%"></asp:BoundField>
                <asp:BoundField DataField="Party" HeaderText="Party" HeaderStyle-Width="20%"></asp:BoundField>
                <asp:BoundField DataField="TrAmt" HeaderText="Tr Amt" HeaderStyle-Width="10%"></asp:BoundField>
                <asp:BoundField DataField="BillType" HeaderText="Bill Type" HeaderStyle-Width="12%"></asp:BoundField>
