<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Accounts.master" CodeFile="JETransactionDetails.aspx.vb" Inherits="Accounts_JETransactionDetails" ValidateRequest="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-9 col-md-9 pull-left">
                <h2><b>Journal Entry Transaction Details</b> </h2>
            </div>
    ...
    <div class="col-sm-12 col-md-12 divmargin" style="padding: 0px">
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            ...
            <div class="col-sm-3 col-md-3">
                ...
                <asp:DropDownList ID="ddlJEType" runat="server" CssClass="aspxcontrols" AutoPostBack="True" ValidationGroup="Validate"></asp:DropDownList>
                <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVddlJEType" runat="server" ControlToValidate="ddlJEType" Display="Dynamic" SetFocusOnError="True"
                     ValidationGroup="Validate"></asp:RequiredFieldValidator>
            </div>

            <div class="col-sm-3 col-md-3">
                <asp:Label runat="server" Text="* Date of Journal Entry"></asp:Label>                
                ...
                <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVInvoiceDate" runat="server" ControlToValidate="txtInvoiceDate" Display="Dynamic" SetFocusOnError="True"
                    ErrorMessage="Enter Date of JE." ValidationGroup="Validate"></asp:RequiredFieldValidator>
        ...
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            ...
            <div class="col-sm-3 col-md-3">
                <asp:Label runat="server" Text="* Voucher Type"></asp:Label>               
        ...
        <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
            ...
            <div class="col-sm-2 col-md-2">
                ...
                <asp:RegularExpressionValidator CssClass="ErrorMsgRight" ID="RFVEBillAmount" runat="server" ControlToValidate="txtBillAmount" Display="Dynamic"
                    SetFocusOnError="True" ValidationGroup="ValidateAdd"></asp:RegularExpressionValidator>
                <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtBillAmount" Display="Dynamic" SetFocusOnError="True"
                    ErrorMessage="Enter Bill Amount." ValidationGroup="Validate"></asp:RequiredFieldValidator>
            </div>
            <div class="col-sm-1 col-md-1">
                <br />
                <asp:ImageButton ID="imgbtnAddBillAmt" runat="server" Width="30%" ValidationGroup="ValidateAdd"></asp:ImageButton>
            </div>
            <div class="col-sm-3 col-md-3">
            </div>
        </div>
            ...
            <div class="col-sm-9 col-md-9" style="padding: 0px">                
                    <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
                        ...
                        <div class="col-sm-3 col-md-3">
                            ...
                            <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVDbHead" runat="server" ControlToValidate="ddldbHead" Display="Dynamic" SetFocusOnError="True"
                                ErrorMessage="Select Head of Accounts."></asp:RequiredFieldValidator>
                        ...
                        ErrorMessage="Select General Ledger." ></asp:RequiredFieldValidator>--%>
                        ...
                        <div class="col-sm-3 col-md-3">
                            ...
                            <asp:DropDownList ID="ddldbsUbGL" runat="server" CssClass="aspxcontrols" AutoPostBack="true" Width="140px"></asp:DropDownList>
                    ...
                    <div class="col-sm-12 col-md-12" style="padding: 0px">
                        ...
                        <div class="col-sm-3 col-md-3">
                            ...
                            <div class="form-group">
                                <asp:TextBox ID="txtCreditAmount" runat="server" CssClass="aspxcontrols" Width="70%" AutoPostBack="true"></asp:TextBox>
    ...
    <div class="col-md-12" style="padding-left: 0px">
     ...
     <div class="col-sm-12 col-md-12">
         <div class="col-sm-0 col-md-0 pull-right">
             <asp:ImageButton ID ="imgbtnDeleteAll" runat ="server" ToolTip ="Delete" ImageUrl ="~/Images/Trash16.png" Visible="false" />
         </div>         
     </div>

    <div class="col-sm-12 col-md-12">
        <asp:DataGrid ID="dgJEDetails" runat="server" AutoGenerateColumns="False" AllowPaging="false" PageSize="20" Width="100%" class="footable">
           <HeaderStyle Font-Bold="true" BackColor="#e5e5e5" />
    ...
    <div id="ModalJEValidation" class="modalmsg fade" data-backdrop="static" data-keyboard="false" role="dialog">
       <div class="modalmsg-dialog">
           <div class="modalmsg-content">
               <div class="modalmsg-header">
               ...
               <div class="modalmsg-body">
                   <div id="divMsgJEType" class="alert alert-info">
                       <p>
                           <strong>
                               <asp:Label ID="lblJEValidation" runat="server"></asp:Label>
                               <asp:Label ID="lblJEDltBillid" runat="server" Visible="false"></asp:Label>
                               <asp:Label ID="lblJEValidationAdd" runat="server"></asp:Label>
                           </strong>
                       </p>
               ...
               <div class="modalmsg-footer">
                   <asp:Button runat="server" Text="Yes" class="btn-ok" ID="btnJEOk"></asp:Button>
                   <asp:Button runat="server" Text="No" class="btn-ok" ID="btnClose"></asp:Button>
               </div>
           </div>
