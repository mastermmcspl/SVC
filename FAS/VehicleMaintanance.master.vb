...
Partial Class VehicleMaintanance
    ...
    Private Sub GetSubMenuOpen()
        Try
            lnkbtnLogistics.Font.Italic = False
            lnkbtnVehicleAddDashBoard.Font.Italic = False : lnkbtnLogistics.Font.Bold = False

            If sSession.SubMenu = "VehicleMaintanance" Then
                liVehicleMaintanance.Attributes.Add("class", "open")
                If sSession.Form = "TripDashboard" Then
                    lnkbtnVehicleAddDashBoard.Font.Italic = True : lnkbtnVehicleAddDashBoard.Font.Bold = True
    ...
    Private Sub GetClickedURL(ByVal sForm As String)
        ...
        Try
            If sForm = "VehicleAddtlnDashboard" Then
                sSession.SubMenu = "VehicleAddtlnDashboard" : sSession.Form = "VehicleAddtlnDashboard"
                Response.Redirect("~/VehicleMaintanance/LgstAddtnlDashboard.aspx", False)
            ElseIf sForm = "AddOns" Then
                sSession.SubMenu = "AddOns" : sSession.Form = "AddOns"
                Response.Redirect("~/VehicleMaintanance/FrmLgstCustBillingDashboard.aspx", False)
            ElseIf sForm = "LoanDtls" Then
                sSession.SubMenu = "LoanDtls" : sSession.Form = "LoanDtls"
                Response.Redirect("~/VehicleMaintanance/LgstLoanDashboard.aspx", False)
            ElseIf sForm = "InsuranceDtls" Then
                sSession.SubMenu = "InsuranceDtls" : sSession.Form = "InsuranceDtls"
                Response.Redirect("~/VehicleMaintanance/LgstInsuranceDashBoard.aspx", False)
            ElseIf sForm = "ServiceDtls" Then
                sSession.SubMenu = "ServiceDtls" : sSession.Form = "ServiceDtls"
                Response.Redirect("~/VehicleMaintanance/LgstServiceDashBoard.aspx", False)
            ElseIf sForm = "AccidentDtls" Then
                sSession.SubMenu = "AccidentDtls" : sSession.Form = "AccidentDtls"
                Response.Redirect("~/VehicleMaintanance/LgstAccidentDtlsDashboard.aspx", False)
            ElseIf sForm = "CostDtls" Then
                sSession.SubMenu = "CostDtls" : sSession.Form = "CostDtls"
                Response.Redirect("~/VehicleMaintanance/LgstCostDtlsDashboard.aspx", False)
            ElseIf sForm = "ComplianceAndAccessoriese" Then
                sSession.SubMenu = "ComplianceAndAccessoriese" : sSession.Form = "ComplianceAndAccessoriese"
                Response.Redirect("~/VehicleMaintanance/LgstComplianceDetails.aspx", False)
            ElseIf sForm = "ComplianceDashboard" Then
                sSession.SubMenu = "ComplianceDashboard" : sSession.Form = "ComplianceDashboard"
                Response.Redirect("~/VehicleMaintanance/LgstComplianceDashboard.aspx", False)
            End If
    ...
    Private Sub lnkbtnVehicleAddDashBoard_Click(sender As Object, e As EventArgs) Handles lnkbtnVehicleAddDashBoard.Click
        Try
            GetClickedURL("VehicleAddtlnDashboard")
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkbtnVehicleAddDashBoard_Click")
        End Try
    End Sub

    Private Sub lnkbtnAddOns_Click(sender As Object, e As EventArgs) Handles lnkbtnAddOns.Click
        Try
            GetClickedURL("AddOns")
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkbtnAddOns_Click")
        End Try
    End Sub
    ...
    Private Sub lnkBtnLoanDtls_Click(sender As Object, e As EventArgs) Handles lnkBtnLoanDtls.Click
        Try
            GetClickedURL("LoanDtls")
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkBtnLoanDtls_Click")
        End Try
    End Sub

    Private Sub lnkBtnInsuranceDtls_Click(sender As Object, e As EventArgs) Handles lnkBtnInsuranceDtls.Click
        Try
            GetClickedURL("InsuranceDtls")
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkBtnInsuranceDtls_Click")
        End Try
    End Sub

    Private Sub lnkBtnServiceDtls_Click(sender As Object, e As EventArgs) Handles lnkBtnServiceDtls.Click
        Try
            GetClickedURL("ServiceDtls")
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkBtnServiceDtls_Click")
        End Try
    End Sub

    Private Sub lnkBtnAccidentDtls_Click(sender As Object, e As EventArgs) Handles lnkBtnAccidentDtls.Click
        Try
            GetClickedURL("AccidentDtls")
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkBtnAccidentDtls_Click")
        End Try
    End Sub

    Private Sub lnkBtnCostDtls_Click(sender As Object, e As EventArgs) Handles lnkBtnCostDtls.Click
        Try
            GetClickedURL("CostDtls")
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkBtnCostDtls_Click")
        End Try
    End Sub

    Private Sub lnkBtnComplianceAndAccessoriese_Click(sender As Object, e As EventArgs) Handles lnkBtnComplianceAndAccessories.Click
        Try
            GetClickedURL("ComplianceAndAccessoriese")
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkBtnComplianceAndAccessoriese_Click")
        End Try
    End Sub

    Private Sub lnkbtnComplianceDashboard_Click(sender As Object, e As EventArgs) Handles lnkbtnComplianceDashboard.Click
        Try
            GetClickedURL("ComplianceDashboard")
        Catch ex As Exception
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "lnkbtnComplianceDashboard_Click")
        End Try
    End Sub
End Class
