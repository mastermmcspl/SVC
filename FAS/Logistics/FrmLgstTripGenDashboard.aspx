<%@ Page Title="" Language="VB" MasterPageFile="~/LogisticsMaster.master" AutoEventWireup="false" CodeFile="FrmLgstTripGenDashboard.aspx.vb" Inherits="Logistics_FrmLgstTripGenDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script lang="javascript" type="text/javascript">
        $(document).ready(function () {
            $('[data-toggle="tooltip"]').tooltip();
             $('#<%=dgTripGenDashboard.ClientID%>').DataTable({
                iDisplayLength: 20,
   ...
   <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-5 col-md-5 pull-left">
                <h2><b>1. Trip Generation Dashboard</b></h2>
            </div>
                    ...
                    <ul class="nav navbar-nav navbar-right logoutDropdown">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                               <li>
                                    <asp:LinkButton runat="server" ID="lnkBtnReport" Text="Report" Style="margin: 0px;" /></li>
                                        <li>
   ...
   <div class="clearfix divmargin"></div>
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgTripGenDashboard" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lblDescName" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Customer") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>               
                ...
                <asp:BoundField DataField="TripStatus" HeaderText="Trip Status" HeaderStyle-Width="10%"></asp:BoundField>
                 <asp:BoundField DataField="CreatedBy" HeaderText="Created By" HeaderStyle-Width="10%"></asp:BoundField>
