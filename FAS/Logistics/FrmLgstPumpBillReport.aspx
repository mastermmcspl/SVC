<%@ Page Title="" Language="VB" MasterPageFile="~/LogisticsMaster.master" AutoEventWireup="false" CodeFile="FrmLgstPumpBillReport.aspx.vb" Inherits="Logistics_FrmLgstPumpBillReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
        <div class="col-sm-3 col-md-3">
            <asp:Label runat="server" Text="* Pump Stations"></asp:Label>
            <asp:DropDownList runat="server" AutoPostBack="true" CssClass="aspxcontrols" ID="ddlPump"></asp:DropDownList>
           <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVPump" runat="server" ControlToValidate="ddlPump" Display="Dynamic" ErrorMessage="Select Pump" SetFocusOnError="True" ValidationGroup="Validate"></asp:RequiredFieldValidator>
             </div>
          <div class="col-sm-3 col-md-3">
