<%@ Page Title="" Language="VB" MasterPageFile="~/LogisticsMaster.master" AutoEventWireup="false" CodeFile="FrmLgstPumpBillDashboard.aspx.vb" Inherits="Logistics_FrmLgstPumpBillDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script lang="javascript" type="text/javascript">
        $(document).ready(function () {
            $('[data-toggle="tooltip"]').tooltip();
             $('#<%=dgPumpBillingDashboard.ClientID%>').DataTable({
                iDisplayLength: 20,
   ...
   <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-5 col-md-5 pull-left">
                <h2><b>2.Pump Billing Dashboard</b></h2>
            </div>
   ...
   <div class="clearfix divmargin"></div>
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgPumpBillingDashboard" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lblDescName" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Pump") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>               
                <asp:BoundField DataField="Id" HeaderText="ID" Visible="false"></asp:BoundField>
                <asp:BoundField DataField="Pump" HeaderText="Pump Name" HeaderStyle-Width="20%"></asp:BoundField>
                ...
                <asp:BoundField DataField="TotalAmt" HeaderText="Total Amount" HeaderStyle-Width="20%"></asp:BoundField>
