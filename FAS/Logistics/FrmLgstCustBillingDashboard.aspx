<%@ Page Title="" Language="VB" MasterPageFile="~/LogisticsMaster.master" AutoEventWireup="false" CodeFile="FrmLgstCustBillingDashboard.aspx.vb" Inherits="Logistics_FrmLgstCustBillingDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script lang="javascript" type="text/javascript">
        $(document).ready(function () {
            $('[data-toggle="tooltip"]').tooltip();
             $('#<%=dgCustomerBillingDashboard.ClientID%>').DataTable({
                iDisplayLength: 20,
   ...
   <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-5 col-md-5 pull-left">
                <h2><b>2.Customer Billing Dashboard</b></h2>
            </div>
   ...
   <div class="clearfix divmargin"></div>
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgCustomerBillingDashboard" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                ...
                <asp:BoundField DataField="Customer" HeaderText="Customer Name" HeaderStyle-Width="20%"></asp:BoundField>
                 <asp:BoundField DataField="InvoiceNo" HeaderText="Invoice No." HeaderStyle-Width="20%"></asp:BoundField>
                <asp:BoundField DataField="InvoiceDate" HeaderText="Invoice Date" HeaderStyle-Width="20%"></asp:BoundField>
                <asp:BoundField DataField="Route" HeaderText="Route" HeaderStyle-Width="20%"></asp:BoundField>
