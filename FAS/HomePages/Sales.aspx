<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Sales.master" CodeFile="Sales.aspx.vb" Inherits="HomePages_Sales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <style>
    ...
    <div class="col-sm-12 col-md-12 form-group">
        <fieldset>
            <asp:Label ID="Label1" runat="server" class="legendbold" Text="Sales DashBoard"></asp:Label>
        </fieldset>
    </div>
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgDD" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                <asp:TemplateField HeaderText="ID" Visible="false">
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ID") %>'></asp:Label>
                        <asp:Label ID="lblSOID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "SOID") %>'></asp:Label>
                        <asp:Label ID="lblALCID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ALCID") %>'></asp:Label>
                        <asp:Label ID="lblDISPID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "DISPID") %>'></asp:Label>
                        <asp:Label ID="lblINID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "INID") %>'></asp:Label>
                        <asp:Label ID="lblRETID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "RETID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="SLNo" HeaderText="SLNo" HeaderStyle-Width="3%"></asp:BoundField>
                <asp:TemplateField HeaderText="Sales Order" HeaderStyle-Width="10%">
                    <ItemTemplate>
                ...
                <asp:BoundField DataField="Supplier" HeaderText="Customer/Party" HeaderStyle-Width="10%"></asp:BoundField>
                <asp:BoundField DataField="Address" HeaderText="Address" HeaderStyle-Width="12%"></asp:BoundField>
                <asp:TemplateField HeaderText="Allocation No" HeaderStyle-Width="12%">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Dispatch No" HeaderStyle-Width="10%">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkDispatchNo" Font-Italic="true" Font-Bold="true" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "DispatchNo") %>' CommandName="ShowIN">LinkButton</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="Rejection" HeaderText="Rejection" HeaderStyle-Width="8%"></asp:BoundField>

                <asp:BoundField DataField="Advance" HeaderText="Advance" HeaderStyle-Width="8%"></asp:BoundField>
                <asp:BoundField DataField="SentToAcc" HeaderText="When Sent To Account" HeaderStyle-Width="20%"></asp:BoundField>
    ...
    <%--<div class="col-sm-12 col-md-12" style="padding: 0px; overflow: auto">
        ...
        <asp:GridView ID="dgViewPI" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                ...
                <asp:BoundField DataField="Commodity" HeaderText="Commodity" HeaderStyle-Width="10%"></asp:BoundField>
                <asp:BoundField DataField="Goods" HeaderText="Description" HeaderStyle-Width="10%"></asp:BoundField>
                ...
                <asp:BoundField DataField="DiscountAmount" HeaderText="DiscountAmount" HeaderStyle-Width="8%"></asp:BoundField>
                ...
                <asp:BoundField DataField="GSTRate" HeaderText="GSTRate" HeaderStyle-Width="5%"></asp:BoundField>  
    ...
    <div class="col-sm-12 col-md-12 form-group">
        <fieldset>
            <asp:Label ID="lblBillDashboard" runat="server" class="legendbold" Text="Bill DashBoard"></asp:Label>
        </fieldset>
    </div>
    <div class="clearfix divmargin"></div>
    <div class="col-sm-12 col-md-12" style="padding: 0px">
            ...
            <Columns>
                <asp:TemplateField HeaderText="ID" Visible="false">
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lblINID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "INID") %>'></asp:Label>
                        <asp:Label ID="lblRETID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "RETID") %>'></asp:Label>
                        <asp:Label ID="lblRMID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "RMID") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="SLNo" HeaderText="SLNo" HeaderStyle-Width="3%"></asp:BoundField>
                <asp:TemplateField HeaderText="Sales Order" HeaderStyle-Width="10%">
