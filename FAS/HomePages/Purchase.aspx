<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Purchase.master" CodeFile="Purchase.aspx.vb" Inherits="HomePages_Purchase" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <style>
    ...
    <div class="col-sm-12 col-md-12 form-group">
        <fieldset>
            <asp:Label ID="Label1" runat="server" class="legendbold" Text ="Purchase DashBoard"></asp:Label>
        </fieldset>
    </div>
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgDD" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                ...
                <asp:BoundField DataField="Supplier" HeaderText="Supplier" HeaderStyle-Width="10%"></asp:BoundField>
                <asp:BoundField DataField="Address" HeaderText="Address" HeaderStyle-Width="18%"></asp:BoundField>
                <asp:TemplateField HeaderText="GinNumber" HeaderStyle-Width="10%">
                    <ItemTemplate>
                ...
                <asp:BoundField DataField="Rejection" HeaderText="Rejection" HeaderStyle-Width="10%"></asp:BoundField>
    ...
    <div class="col-sm-12 col-md-12 form-group">
        <fieldset>
            <asp:Label ID="lblGoods" runat="server" class="legendbold" Text ="Details of Goods"></asp:Label>
        </fieldset>
    </div>
    ...
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgBD" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                ...
                <asp:BoundField DataField="SLNo" HeaderText="SLNo" HeaderStyle-Width="3%"></asp:BoundField>
                <asp:TemplateField HeaderText="Purchase Order" HeaderStyle-Width="10%">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkPO" Font-Italic="true" Font-Bold="true" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "PO") %>' CommandName="ShowPO">LinkButton</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="Supplier" HeaderText="Supplier" HeaderStyle-Width="10%"></asp:BoundField>
                <asp:BoundField DataField="Address" HeaderText="Address" HeaderStyle-Width="25%"></asp:BoundField>
                <asp:TemplateField HeaderText="GinNumber" HeaderStyle-Width="10%">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkGinNumber" Font-Italic="true" Font-Bold="true" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "GinNumber") %>' CommandName="ShowGIN">LinkButton</asp:LinkButton>
                    </ItemTemplate>
