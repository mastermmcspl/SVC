<%@ Page Title="" Language="VB" MasterPageFile="~/Sales.master" AutoEventWireup="false" CodeFile="DispatchFormMaster.aspx.vb" Inherits="Sales_DispatchFormMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="clearfix divmargin"></div>
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgDF" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
               ...
               <%-- <asp:BoundField DataField="ID" HeaderText="ID" Visible="false"></asp:BoundField>--%>
                <asp:BoundField DataField="InvoiceNo" HeaderText="DispatchNo" HeaderStyle-Width="20%"></asp:BoundField>
                <asp:BoundField DataField="InvoiceDate" HeaderText="Dispatch Date" HeaderStyle-Width="10%"></asp:BoundField>
