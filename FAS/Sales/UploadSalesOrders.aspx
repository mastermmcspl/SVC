<%@ Page Title="" Language="VB" MasterPageFile="~/Sales.master" AutoEventWireup="false" CodeFile="UploadSalesOrders.aspx.vb" Inherits="Sales_UploadSalesOrders" %>
    ...
    <script type="text/javascript" language="javascript" src="../JavaScripts/General.js"></script>
     <script type="text/javascript" language="javascript">
         ...
         function validateSave() {            
              ...
              if (document.getElementById('<%=ddlSheetName.ClientID %>').selectedIndex == 0) {
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-3 col-md-3 pull-left">
                <h2><b>Sales Order Upload(Excel)</b></h2>
            </div>
   ...
   <%-- <div class="col-sm-12 col-md-12 divmargin" style="padding-left: 0; padding-right: 0">
    ...
    <div class="col-sm-12 col-md-12 divmargin" style="padding-left: 0; padding-right: 0">
        <div class="col-sm-8 col-md-8" style="padding-left: 0; padding-right: 0">
            <asp:Label ID="lblMesg" runat="server" Font-Bold ="true" ForeColor="Blue" CssClass="ErrorMsgLeft"></asp:Label>
        </div>
        <div class="col-sm-8 col-md-8" style="padding-left: 0; padding-right: 0">
            <asp:Label ID="lblError" runat="server" CssClass="ErrorMsgLeft"></asp:Label>
        </div>
        <div class="col-sm-4 col-md-4 divmargin" style="padding-right: 0px">
            <asp:LinkButton runat="server" ID="LnkbtnExcel" Text="Sales Order Upload(Excel)" Font-Bold="False" Font-Underline="True" ForeColor="Blue" />
        </div>
     ...
     <%--   <div id="collapseRRIT" class="collapse">--%>
        ...
        <div class="col-sm-4 col-md-4" style="padding-left: 0;">
            <div class="form-group">
                ...
                <asp:DropDownList ID="ddlParty" runat="server" AutoPostBack="true" CssClass="aspxcontrols">  
                </asp:DropDownList>
            </div>
        </div>
