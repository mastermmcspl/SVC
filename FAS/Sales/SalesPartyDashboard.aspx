<%@ Page Title="" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="SalesPartyDashboard.aspx.vb" Inherits="Sales_SalesPartyDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="clearfix divmargin"></div>
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgParty" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lblDescName" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PartyName") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>               
                <asp:BoundField DataField="ID" HeaderText="ID" Visible="false"></asp:BoundField>
                <asp:BoundField DataField="PartyName" HeaderText="Party Name" HeaderStyle-Width="13%"></asp:BoundField>
                <asp:BoundField DataField="PartyCode" HeaderText="Party Code" HeaderStyle-Width="10%"></asp:BoundField>
                ...
                <asp:BoundField DataField="Email" HeaderText="Email" HeaderStyle-Width="20%"></asp:BoundField>
