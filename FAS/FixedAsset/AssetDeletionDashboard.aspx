...
<%@ Page Title="" Language="VB" MasterPageFile="~/FixedAsset.master" AutoEventWireup="false" CodeFile="AssetDeletionDashboard.aspx.vb" Inherits="FixedAsset_DltnDashBoard" %>
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-4 col-md-4 pull-left">
                <h2><b>Asset Deletion DashBoard</b></h2>
            </div>
    ...
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="GvAsserDetails" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                ...
                <asp:BoundField DataField="DeleteDate" HeaderText="Delete Date" Visible="true" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="2%"></asp:BoundField>
