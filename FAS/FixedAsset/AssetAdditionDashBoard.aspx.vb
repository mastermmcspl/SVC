...
Partial Class FixedAsset_AssetAdditionDashBoard
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If IsPostBack = False Then
                ...
                dtDetails = objAddDsb.LoadAllDetails(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID)
    ...
    Private Sub ddlStatus_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlStatus.SelectedIndexChanged
        ...
        Try
            ...
            If ddlStatus.SelectedIndex = 0 Then
                dt = objAddDsb.LoadAllDetails1(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "A")
                GvAsserDetails.DataSource = dt
                GvAsserDetails.DataBind()
            ElseIf ddlStatus.SelectedIndex = 1 Then
                dt = objAddDsb.LoadAllDetails1(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "X")
                GvAsserDetails.DataSource = dt
                GvAsserDetails.DataBind()
            ElseIf ddlStatus.SelectedIndex = 2 Then
                dt = objAddDsb.LoadAllDetails1(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "W")
                GvAsserDetails.DataSource = dt
                GvAsserDetails.DataBind()
            ElseIf ddlStatus.SelectedIndex = 3 Then
                dt = objAddDsb.LoadAllDetails(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID)
                GvAsserDetails.DataSource = dt
                GvAsserDetails.DataBind()
            End If
    ...
    Private Sub lnkbtnExcel_Click(sender As Object, e As EventArgs) Handles lnkbtnExcel.Click
        ...
        Dim dt As New DataTable
        Try
            dt = objAddDsb.GetDetails(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID)
            If dt.Rows.Count = 0 Then
