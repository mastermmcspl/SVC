<%@ Page Title="" Language="VB" MasterPageFile="~/Accounts.master" AutoEventWireup="false" CodeFile="ValueReport.aspx.vb" Inherits="Reports_ValueReport" %>
        ...
        <asp:GridView ID="dgReport" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Purchase Qty" HeaderStyle-Width="11%">
                 ...
                 <asp:TemplateField HeaderText="Purchase Value" HeaderStyle-Width="11%">
                    <ItemTemplate>
                        <asp:Label ID="lblPurchaseValue" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "PurchaseValue") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Sale Value" HeaderStyle-Width="11%">
                    <ItemTemplate>
                        <asp:Label ID="lblSaleValue" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "SaleValue") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
