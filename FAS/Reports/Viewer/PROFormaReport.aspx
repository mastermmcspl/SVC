<%@ Page Title="" Language="VB" MasterPageFile="~/Sales.master" AutoEventWireup="false" CodeFile="PROFormaReport.aspx.vb" Inherits="Reports_Viewer_PROFormaReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="99%" Height="539px" InternalBorderColor="Blue" LinkDisabledColor="Blue" PageCountMode="Actual" ToolBarItemBorderColor="DarkRed">
            <LocalReport ReportPath="PROForma.rdlc">
                <DataSources>
