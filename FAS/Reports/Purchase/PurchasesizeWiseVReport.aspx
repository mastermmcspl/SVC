<%@ Page Title="" Language="VB" MasterPageFile="~/Purchase.master" AutoEventWireup="false" CodeFile="PurchasesizeWiseVReport.aspx.vb" Inherits="Reports_Purchase_PurchasesizeWiseVReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <%--  <table>
    ...
    <table>
      ...
      <asp:Label ID="lblOrderNo" runat="server" Text="Order No" CssClass="Label" Width="150px"></asp:Label>
        <asp:Label ID="lblInvoiceNo" runat="server" Text="Order No" CssClass="Label" Width="150px"></asp:Label>
</asp:Content>
