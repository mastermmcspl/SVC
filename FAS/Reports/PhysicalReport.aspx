<%@ Page Title="" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="PhysicalReport.aspx.vb" Inherits="Reports_PhysicalReport" %>
    ...
    <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
        <asp:GridView ID="dgReport" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Sl No" HeaderStyle-Width="10%" Visible="true">
                    <ItemTemplate>
                        <asp:Label ID="lblSlNo" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Sl No") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="MRP" HeaderStyle-Width="13%" Visible="true">
                    <ItemTemplate>
                        <asp:Label ID="lblMRP" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "MRP") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Commodity" HeaderStyle-Width="20%" Visible="true">
                    <ItemTemplate>
