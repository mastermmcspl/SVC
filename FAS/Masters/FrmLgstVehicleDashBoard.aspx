...
<%@ Page Title="" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="FrmLgstVehicleDashBoard.aspx.vb" Inherits="Masters_FrmLgstVehicleDashBoard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-4 col-md-4 pull-left">
                <h2><b>Vehicel Master DashBoard</b></h2>
            </div>
   ...
   <asp:ImageButton ID="imgbtnActivate" CssClass="activeIcons hvr-bounce-out" runat="server" data-toggle="tooltip" data-placement="bottom" title="Activate" />
    ...
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="GvVehicleMaster" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            ...
            <asp:TemplateField HeaderStyle-Width="2%">
                ...
                <asp:BoundField DataField="OwnerName" HeaderText="Owner Name" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="15%"></asp:BoundField>
                <asp:BoundField DataField="ChassisNo" HeaderText="Chassis No" Visible="true" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="2%"></asp:BoundField>
    ...
    <div id="ModalasserVehicleValidation" class="modalmsg fade" data-backdrop="static" data-keyboard="false" role="dialog">
