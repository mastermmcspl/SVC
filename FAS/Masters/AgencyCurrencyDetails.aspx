<%@ Page Title="" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="AgencyCurrencyDetails.aspx.vb" Inherits="Masters_AgencyCurrencyDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-9 col-md-9 pull-left">
                <h2><b>6.2 Agency Currency Master Details</b></h2>
            </div>            
    ...
    <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
        <div class="col-sm-3 col-md-3">
            ...
            <asp:Label ID="lblAgencyName" runat="server" CssClass="aspxlabelbold"></asp:Label>
        </div>
         <div class="col-sm-3 col-md-3">
        ...
        <div class="col-sm-3 col-md-3">
            ...
            <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RFVddlFromCurrency" runat="server" ControlToValidate="ddlfromcurrency" Display="Dynamic" SetFocusOnError="True" ValidationGroup="Validate"></asp:RequiredFieldValidator>
        </div>
        <div class="col-sm-3 col-md-3">
            <asp:Label ID="lblExchangeRate" runat="server" Text="* Unit of Foreign Currency"></asp:Label>
            <asp:TextBox ID="txtExchangeRate" runat="server" CssClass="aspxcontrols" TabIndex="4" Enabled="true" Text="1"></asp:TextBox>         
        </div>
    </div>
    <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
        <div class="col-sm-3 col-md-3">
