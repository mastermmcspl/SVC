...
Partial Class Masters_CustomerMaster
    Inherits System.Web.UI.Page
    Private sFormName As String = "Masters/CustomerMasterDetails"
    ...
    Private Sub dgParty_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles dgParty.RowDataBound
        ...
        Try
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                dgParty.Columns(0).Visible = True : dgParty.Columns(8).Visible = False : dgParty.Columns(9).Visible = True

                If ddlStatus.SelectedIndex = 0 Then
                    imgbtnStatus.ImageUrl = "~/Images/DeActivate16.png" : imgbtnStatus.ToolTip = "De-Activate"
                    If sCMAD = "YES" Then
                        dgParty.Columns(8).Visible = True
                    End If
                    'If sCMSave = "YES" Then
                ...
                If ddlStatus.SelectedIndex = 3 Then
                    dgParty.Columns(8).Visible = False : dgParty.Columns(9).Visible = False
                End If
            End If
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "dgParty_RowDataBound")
        End Try
    End Sub
    Private Sub dgParty_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles dgParty.RowCommand
        ...
        Try
            ...
            If e.CommandName.Equals("Edit") Then
                ...
                End If
                oMasterID = HttpUtility.UrlEncode(objGen.EncryptQueryString(Val(lblDescID.Text)))
                Response.Redirect(String.Format("~/Masters/CustomerMasterDetails.aspx?StatusID={0}&PID={1}", oStatusID, oMasterID), False) 'GeneralMasterDetails
            End If
        ...
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "dgParty_RowCommand")
        End Try
    End Sub
    Private Sub imgbtnAdd_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnAdd.Click
        ...
        Try
            ...
            End If
            Response.Redirect(String.Format("~/Masters/CustomerMasterDetails.aspx?StatusID={0}&PID={1}", oStatusID, oMasterName), False)
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
    ...
    Private Sub imgbtnActivate_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnActivate.Click
        ...
        Try
            ...
            If dgParty.Rows.Count = 0 Then
                ...
                Exit Sub
            End If
            For i = 0 To dgParty.Rows.Count - 1
                chkSelect = dgParty.Rows(i).FindControl("chkSelect")
            ...
            If iCount = 0 Then
                ...
                Exit Sub
            End If
NextSave:   For i = 0 To dgParty.Rows.Count - 1
                chkSelect = dgParty.Rows(i).FindControl("chkSelect")
                lblDescID = dgParty.Rows(i).FindControl("lblDescID")
                If chkSelect.Checked = True Then
                    objSPD.UpdatePartyMasterStatusWhole(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "D", "A", sSession.UserID, sSession.IPAddress, lblDescID.Text)
...
NextSave:   For i = 0 To dgParty.Rows.Count - 1
                ...
                lblDescID = dgParty.Rows(i).FindControl("lblDescID")
                If chkSelect.Checked = True Then
                    objSPD.UpdatePartyMasterStatusWhole(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "A", "D", sSession.UserID, sSession.IPAddress, lblDescID.Text)
...
NextSave:   For i = 0 To dgParty.Rows.Count - 1
                ...
                lblDescID = dgParty.Rows(i).FindControl("lblDescID")
                If chkSelect.Checked = True Then
                    objSPD.UpdatePartyMasterStatusWhole(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "W", "A", sSession.UserID, sSession.IPAddress, lblDescID.Text)
    ...
    Private Sub lnkbtnExcel_Click(sender As Object, e As EventArgs) Handles lnkbtnExcel.Click
        ...
        Dim dt As New DataTable
        Try
            dt = objSPD.LoadSalesParty(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, ddlStatus.SelectedIndex)
