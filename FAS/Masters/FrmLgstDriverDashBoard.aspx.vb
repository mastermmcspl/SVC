...
Partial Class Masters_FrmLgstDriverDashBoard
    Inherits System.Web.UI.Page
    Private sFormName As String = "LgstDriverDashBoard"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If IsPostBack = False Then
                ...
                dtDetails = objDriverMas.LoadAllDetails1(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "A")
                GvDriverMaster.DataSource = dtDetails
    ...
    Private Sub ddlStatus_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlStatus.SelectedIndexChanged
        ...
        Try
            ...
            If ddlStatus.SelectedIndex = 0 Then
                ...
                dt = objDriverMas.LoadAllDetails1(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "W")
            ...
            ElseIf ddlStatus.SelectedIndex = 1 Then
                ...
                dt = objDriverMas.LoadAllDetails1(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "A")
                GvDriverMaster.DataSource = dt
                GvDriverMaster.DataBind()
            ElseIf ddlStatus.SelectedIndex = 2 Then
                ...
                dt = objDriverMas.LoadAllDetails1(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "D")
                GvDriverMaster.DataSource = dt
                GvDriverMaster.DataBind()
            ElseIf ddlStatus.SelectedIndex = 3 Then
                ...
                dt = objDriverMas.LoadAllDetails(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID)
                GvDriverMaster.DataSource = dt
                GvDriverMaster.DataBind()
            End If
    ...
    Private Sub imgbtnAdd_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnAdd.Click
        ...
        Try
            ...
            Response.Redirect(String.Format("~/Masters/FrmLgstDriverMaster.aspx?StatusID={0}&MasterName={1}", oStatusID, oMasterName), False)
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "imgbtnAdd_Click")
        End Try
    End Sub
    Private Sub GvDriverMaster_PreRender(sender As Object, e As EventArgs) Handles GvDriverMaster.PreRender
        Try
            If GvDriverMaster.Rows.Count > 0 Then
                GvDriverMaster.UseAccessibleHeader = True
                GvDriverMaster.HeaderRow.TableSection = TableRowSection.TableHeader
                GvDriverMaster.FooterRow.TableSection = TableRowSection.TableFooter
            End If
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "GvDriverMaster_PreRender")
        End Try
    End Sub
    ...
    '            For iIndx = 0 To GvDriverMaster.Rows.Count - 1
    '                chkField = GvDriverMaster.Rows(iIndx).FindControl("chkSelect")
    ...
    Protected Sub chkSelectAll_CheckedChanged(sender As Object, e As EventArgs)
        ...
        End Try
    End Sub
    'Private Sub GvDriverMaster_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GvDriverMaster.RowDataBound
    ...
    '            GvDriverMaster.Columns(0).Visible = True
    '            imgbtnStatus.ImageUrl = "~/Images/Activate16.png"
    '            If ddlStatus.SelectedIndex = 0 Then
    '                GvDriverMaster.Columns(8).Visible = True
    '            Else
    '                GvDriverMaster.Columns(8).Visible = False
    '            End If
    '        End If
    '    Catch ex As Exception
    '        lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
    '        Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "GvDriverMaster_RowDataBound")
    '    End Try
    'End Sub
    Private Sub GvDriverMaster_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GvDriverMaster.RowCommand
        ...
        Try
            ...
            If e.CommandName.Equals("Edit1") Then
                ...
                End If
                '  oMasterID = HttpUtility.UrlEncode(objGen.EncryptQueryString(Val(lblDescID.Text)))
                Response.Redirect(String.Format("~/Masters/FrmLgstDriverMaster.aspx?MasterID={0}", oMasterID), False)
            End If
            'If e.CommandName.Equals("Status") Then
            '    If ddlStatus.SelectedIndex = 0 Then
            '        objDriverMas.UpdateDriverStatus(sSession.AccessCode, sSession.AccessCodeID, lblDescID.Text, sSession.UserID, sSession.IPAddress, sSession.YearID)
            ...
            If e.CommandName.Equals("Status") Then
                If ddlStatus.SelectedIndex = 0 Then
                    objDriverMas.UpdateDriverStatusDashboard(sSession.AccessCode, sSession.AccessCodeID, lblDescID.Text, "A", sSession.UserID, sSession.IPAddress, sSession.YearID)
                ...
                If ddlStatus.SelectedIndex = 1 Then
                    objDriverMas.UpdateDriverStatusDashboard(sSession.AccessCode, sSession.AccessCodeID, lblDescID.Text, "D", sSession.UserID, sSession.IPAddress, sSession.YearID)
                    lblDltnValidationMsg.Text = "Successfully Activated." : lblError.Text = "Successfully Activated."
                    ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Modal", "$('#divMsgType').addClass('alert alert-success');$('#ModalPaymentValidation').modal('show');", True)
                End If
                If ddlStatus.SelectedIndex = 2 Then
                    objDriverMas.UpdateDriverStatusDashboard(sSession.AccessCode, sSession.AccessCodeID, lblDescID.Text, "W", sSession.UserID, sSession.IPAddress, sSession.YearID)
        ...
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "GvDriverMaster_RowCommand")
        End Try
    End Sub
    Private Sub GvDriverMaster_RowDeleting(sender As Object, e As GridViewDeleteEventArgs) Handles GvDriverMaster.RowDeleting
    ...
    Private Sub GvDriverMaster_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles GvDriverMaster.RowDataBound
        ...
        Try
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                imgbtnEdit = CType(e.Row.FindControl("imgbtnedit"), ImageButton)
                imgbtnEdit.ImageUrl = "~/Images/Edit16.png"
                GvDriverMaster.Columns(0).Visible = True : GvDriverMaster.Columns(7).Visible = False : GvDriverMaster.Columns(8).Visible = True

                If ddlStatus.SelectedIndex = 0 Then

                    imgbtnStatus.ImageUrl = "~/Images/Checkmark16.png" : imgbtnStatus.ToolTip = "Approve"
                    GvDriverMaster.Columns(8).Visible = True
                    GvDriverMaster.Columns(7).Visible = True
                    'If sCMAD = "YES" Then
                ...
                If ddlStatus.SelectedIndex = 3 Then
                    GvDriverMaster.Columns(7).Visible = False : GvDriverMaster.Columns(8).Visible = False
                End If
            End If
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
    ...
    Private Sub imgbtnActivate_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnActivate.Click
        ...
        Try
            ...
            If GvDriverMaster.Rows.Count = 0 Then
                ...
                Exit Sub
            End If
            For i = 0 To GvDriverMaster.Rows.Count - 1
                chkSelect = GvDriverMaster.Rows(i).FindControl("chkSelect")
            ...
            If iCount = 0 Then
                ...
                Exit Sub
            End If
NextSave:   For i = 0 To GvDriverMaster.Rows.Count - 1
                chkSelect = GvDriverMaster.Rows(i).FindControl("chkSelect")
                lblDescID = GvDriverMaster.Rows(i).FindControl("lblDescID")
                If chkSelect.Checked = True Then
                    objDriverMas.UpdateDriverMasterStatusWhole(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "D", "A", sSession.UserID, sSession.IPAddress, lblDescID.Text)
                    lblError.Text = "Successfully Activated."
                    ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Popup", "swal('Successfully Activated','', 'success');", True)
                End If
            Next
...
NextSave:   For i = 0 To GvDriverMaster.Rows.Count - 1
                ...
                lblDescID = GvDriverMaster.Rows(i).FindControl("lblDescID")
                If chkSelect.Checked = True Then
                    objDriverMas.UpdateDriverMasterStatusWhole(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "A", "D", sSession.UserID, sSession.IPAddress, lblDescID.Text)
...
NextSave:   For i = 0 To GvDriverMaster.Rows.Count - 1
                ...
                lblDescID = GvDriverMaster.Rows(i).FindControl("lblDescID")
                If chkSelect.Checked = True Then
                    objDriverMas.UpdateDriverMasterStatusWhole(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, "W", "A", sSession.UserID, sSession.IPAddress, lblDescID.Text)
