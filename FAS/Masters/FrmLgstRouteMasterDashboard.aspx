<%@ Page Title="" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="FrmLgstRouteMasterDashboard.aspx.vb" Inherits="Masters_FrmLgstRouteMasterDashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-5 col-md-5 pull-left">
                <h2><b>3.5 Route Master Dashboard</b></h2>
            </div>
   ...
   <div class="clearfix divmargin"></div>
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgRoute" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lblDescName" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.StartPlace") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>               
                <asp:BoundField DataField="ID" HeaderText="ID" Visible="false"></asp:BoundField>
                <asp:BoundField DataField="StartPlace" HeaderText="Start Place." HeaderStyle-Width="30%"></asp:BoundField>
                <asp:BoundField DataField="DestinationPlace" HeaderText="Destination Place" HeaderStyle-Width="33%"></asp:BoundField>
                <asp:BoundField DataField="VehicleType" HeaderText="Vehicle Type" HeaderStyle-Width="20%"></asp:BoundField>  
