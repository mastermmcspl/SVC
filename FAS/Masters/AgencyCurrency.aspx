<%@ Page Title="" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="AgencyCurrency.aspx.vb" Inherits="Masters_AgencyCurrency" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="reportDetailsMN">
        <div class="sectionTitleMn">
            <div class="col-sm-4 col-md-4 pull-left">
                <h2><b>5.2 Agency Currency Master</b></h2>
            </div>
             <div class="col-sm-5 col-md-5">
                 <asp:Label ID="lblAuditStartDate" runat="server" Text="From"></asp:Label>
                 <asp:TextBox ID="txtStartDate" autocomplete="off" runat="server" Width="140px" CssClass="aspxcontrols" MaxLength="10" placeholder="dd/MM/yyyy" Visible="True"></asp:TextBox>
                 ...
                 <asp:TextBox ID="txtEndDate" autocomplete="off" runat="server" Width="140px" CssClass="aspxcontrols" MaxLength="10" placeholder="dd/MM/yyyy" Visible="True"></asp:TextBox>
    ...
    <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
       ...
       <div class="col-sm-3 col-md-3">
            <asp:Label ID="lblBankName" runat="server" Text="* Agency"></asp:Label>          
            <asp:DropDownList ID="ddlAgencyName" runat="server" AutoPostBack="true" CssClass="aspxcontrols" TabIndex="3">
            </asp:DropDownList>           
        </div>  
        <div class="col-sm-3 col-md-3">
        ...
        <div class="col-sm-3 col-md-3">
            ...
            <asp:DropDownList ID="ddlfromcurrency" runat="server" CssClass="aspxcontrols" TabIndex="2" AutoPostBack="true">
            </asp:DropDownList>
        </div>   
    </div>
            ...
            <Columns>
                <asp:TemplateField HeaderText="">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lblCurID" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem, "CurID") %>'></asp:Label> 
                        <asp:Label ID="lblCurrID" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem, "CurrID") %>'></asp:Label>                                             
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="SrNo" HeaderText="Sr.No" ItemStyle-Width="3%" />
                <asp:BoundField DataField="AgencyName" HeaderText="Agency Name" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="10%"></asp:BoundField>
                <asp:BoundField DataField="OperateOn" HeaderText="Currency" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="12%"></asp:BoundField>
                <asp:BoundField DataField="Currency" HeaderText="Base Currency" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="12%"></asp:BoundField>                
                ...
                <asp:BoundField DataField="BankName" HeaderText="Bank" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="17%"></asp:BoundField>
                <asp:TemplateField HeaderText="Date" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="5%">
                    <ItemTemplate>
                        <asp:Label ID="lblDate" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Date") %>'></asp:Label>                                            
                    </ItemTemplate>
                </asp:TemplateField>               
                <asp:BoundField DataField="Time" HeaderText="Time" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="5%"></asp:BoundField>
                <asp:BoundField DataField="CreatedBy" HeaderText="CreatedBy" HeaderStyle-HorizontalAlign="Left" HeaderStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left" ItemStyle-VerticalAlign="Top" HeaderStyle-Width="5%"></asp:BoundField>
                ...
                <asp:TemplateField HeaderStyle-Width="2%" ItemStyle-Width="2%">
                    <ItemTemplate>                        
                        <asp:ImageButton ID="imgbtnEdit" data-toggle="tooltip" data-placement="bottom" title="Edit" CommandName="EditData" runat="server" CssClass="hvr-bounce-in" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
