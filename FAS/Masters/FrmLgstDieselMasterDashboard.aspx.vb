...
Partial Class Masters_LgstDieselMasterDashboard
    Inherits System.Web.UI.Page
    Private sFormName As String = "Masters/DeiselMasterDetails"
    ...
    Public Sub BindSODetails(ByVal iPageIndex As Integer, ByVal iStatus As Integer)
        ...
        Try
            ...
            Else
                imgbtnWaiting.Visible = False : imgbtnDeActivate.Visible = False : imgbtnActivate.Visible = False
            End If
            dt = objDPM.LoadDesielPumpDetails(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, iStatus)
            dgDiesel.DataSource = dt
            dgDiesel.DataBind()
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
        ...
        End Try
    End Sub
    Private Sub dgDiesel_PreRender(sender As Object, e As EventArgs) Handles dgDiesel.PreRender
        Dim dt As New DataTable
        Try
            If dgDiesel.Rows.Count > 0 Then
                dgDiesel.UseAccessibleHeader = True
                dgDiesel.HeaderRow.TableSection = TableRowSection.TableHeader
                dgDiesel.FooterRow.TableSection = TableRowSection.TableFooter
            End If
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "dgDiesel_PreRender")
        End Try
    End Sub
    Private Sub dgDiesel_RowDataBound(sender As Object, e As GridViewRowEventArgs) Handles dgDiesel.RowDataBound
        ...
        Try
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                dgDiesel.Columns(0).Visible = True : dgDiesel.Columns(7).Visible = False : dgDiesel.Columns(8).Visible = True
                ...
                If ddlStatus.SelectedIndex = 3 Then
                    dgDiesel.Columns(7).Visible = False : dgDiesel.Columns(8).Visible = False
                End If
            End If
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
            Components.AppException.LogError(sSession.AccessCode, ex.Message, sFormName, "dgDiesel_RowDataBound")
        End Try
    End Sub
    Private Sub dgDiesel_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles dgDiesel.RowCommand
        ...
        Try
            ...
            If e.CommandName.Equals("Edit") Then
                ...
                End If
                oMasterID = HttpUtility.UrlEncode(objGen.EncryptQueryString(Val(lblDescID.Text)))
                Response.Redirect(String.Format("~/Masters/FrmLgstDieselMaster.aspx?StatusID={0}&PID={1}", oStatusID, oMasterID), False) 'GeneralMasterDetails
            End If
    ...
    Private Sub imgbtnAdd_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnAdd.Click
        ...
        Try
            ...
            End If
            Response.Redirect(String.Format("~/Masters/FrmLgstDieselMaster.aspx?StatusID={0}&PID={1}", oStatusID, oMasterName), False)
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
...
NextSave:   For i = 0 To dgDiesel.Rows.Count - 1
    ...
    Protected Sub chkSelectAll_CheckedChanged(sender As Object, e As EventArgs)
        ...
        End Try
    End Sub
    Private Sub dgParty_RowEditing(sender As Object, e As GridViewEditEventArgs) Handles dgDiesel.RowEditing
    ...
    Private Sub lnkbtnExcel_Click(sender As Object, e As EventArgs) Handles lnkbtnExcel.Click
        ...
        Dim dt As New DataTable
        Try
            dt = objDPM.LoadDesielPumpDetails(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID, ddlStatus.SelectedIndex)
