<%@ Page Title="" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="SupplierMaster.aspx.vb" Inherits="Masters_SupplierMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgSupplier" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                <asp:TemplateField>
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lblDescName" Visible="false" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Supplier") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="ID" HeaderText="ID" Visible="false"></asp:BoundField>
                <asp:BoundField DataField="Supplier" HeaderText="Supplier Name" HeaderStyle-Width="20%"></asp:BoundField>
                <asp:BoundField DataField="Address" HeaderText="Address" HeaderStyle-Width="25%"></asp:BoundField>
                <asp:BoundField DataField="State" HeaderText="State" HeaderStyle-Width="10%"></asp:BoundField>
                <asp:BoundField DataField="Pincode" HeaderText="Pincode" HeaderStyle-Width="5%"></asp:BoundField>               
    ...
    <div id="ModalSupplierValidation" class="modalmsg fade" data-backdrop="static" data-keyboard="false" role="dialog">
            ...
            <div class="modalmsg-content">
                ...
                <div class="modalmsg-body">
                    <div id="divMsgType" class="alert alert-info">
                        <p>
                            <strong>
                                <asp:Label ID="lblSupplierMasterValidationMsg" runat="server"></asp:Label></strong>
                        </p>
                    </div>
                </div>
