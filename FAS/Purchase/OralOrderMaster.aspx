<%@ Page Title="" Language="VB" MasterPageFile="~/Purchase.master" AutoEventWireup="false" CodeFile="OralOrderMaster.aspx.vb" Inherits="Purchase_OralOrderMaster" %>
    ...
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgDD" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                ...
                <asp:BoundField DataField="GinNumber" HeaderText="Order Number" HeaderStyle-Width="20%"></asp:BoundField>
                <asp:BoundField DataField="InvoiceNo" HeaderText="InvoiceNo" HeaderStyle-Width="20%" Visible="false"></asp:BoundField>
                <asp:BoundField DataField="InvoiceDate" HeaderText="Order Date" HeaderStyle-Width="10%"></asp:BoundField>
                <asp:BoundField DataField="Customer" HeaderText="Supplier" HeaderStyle-Width="30%"></asp:BoundField>
