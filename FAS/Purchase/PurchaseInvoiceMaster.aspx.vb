...
Partial Class Sales_DispatchDetailsMaster
    ...
    Private Shared sPRSave As String
    Dim objclsModulePermission As New clsModulePermission
    Dim objDDM As New clsPurchaseRegistryMaster
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If IsPostBack = False Then
                ...
                imgbtnReport.Visible = False : sPRSave = "NO"
    ...
    Private Sub dgDD_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles dgDD.RowCommand
        ...
        Try
            ...
            'If e.CommandName.Equals("Edit") Then
            '    oMasterID = HttpUtility.UrlEncode(objGen.EncryptQueryString(Val(lblDescID.Text)))
            '    Response.Redirect(String.Format("~/Purchase/PurchaseInvoiceEntry.aspx?DID={0}", oMasterID), False)
            'End If
        Catch ex As Exception
            lblError.Text = ex.Message
    ...
    Private Sub lnkbtnExcel_Click(sender As Object, e As EventArgs) Handles lnkbtnExcel.Click
        ...
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rdlc/PurchaseMaster/rptPurchaseRegister.rdlc")
    ...
    Private Sub lnkbtnPDF_Click(sender As Object, e As EventArgs) Handles lnkbtnPDF.Click
        ...
        Try
            ...
            Response.AddHeader("content-disposition", "attachment; filename=PurchaseRegister" + ".pdf")
            Response.BinaryWrite(RptViewer)
            Response.Flush()
            Response.End()
        Catch ex As Exception
