<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Purchase.master" CodeFile="PurchaseReturn.aspx.vb" Inherits="Purchase_Purchase_Return" EnableEventValidation="false" ValidateRequest="false" %>
...
<%--        function ValidatePrint() {
    ...
    <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
        <div class="col-sm-3 col-md-3">
            ...
            <asp:DropDownList runat="server" AutoPostBack="true" CssClass="auto-style3" ID="ddlInvoiceNo"></asp:DropDownList>
        ...
        <div class="col-sm-3 col-md-3">
            ...
            <asp:TextBox runat="server" AutoPostBack="true" CssClass="aspxcontrols" ID="purchaseReturnNo" Enabled="False"></asp:TextBox>
    ...
    <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
        ...
        <div class="col-sm-3 col-md-3">
            ...
            <asp:DropDownList runat="server" AutoPostBack="true" CssClass="auto-style3" ID="ddlTypeOfSale"></asp:DropDownList>
    ...
    <div class="col-sm-12 col-md-12 form-group">
        ...
        <div class="col-sm-6 col-md-6" style="padding-left: 0px">
            ...
            <div class="col-sm-12 col-md-12" style="padding: 0px">
                <asp:ListBox ID="chkCategory" CssClass="col-sm-12 col-md-12 pre-scrollableborder" runat="server" AutoPostBack="True" Height="558px"></asp:ListBox>
            </div>
        </div>
        <div class="col-sm-6 col-md-6" style="padding: 0px">
            <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
                <div class="col-sm-6 col-md-6">
                    ...
                    <asp:TextBox runat="server" AutoPostBack="true" CssClass="aspxcontrols" ID="txtQty" Enabled="False"></asp:TextBox>
                </div>
            ...
            <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
                ...
                <div class="col-sm-6 col-md-6" style="padding-right: 0px">
                    ...
                    <asp:TextBox autocomplete="off" runat="server" CssClass="aspxcontrols" data-toggle="tooltip" data-placement="top" ID="txtNarration" ReadOnly="false" TextMode="MultiLine"></asp:TextBox>
                    <%--                      <asp:RequiredFieldValidator CssClass="ErrorMsgRight" ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtRate"  Display="Dynamic" SetFocusOnError="True" ValidationGroup="ValidateQty"></asp:RequiredFieldValidator>--%>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
                <div class="col-sm-6 col-md-6">
                    ...
                    <asp:TextBox runat="server" AutoPostBack="true" CssClass="aspxcontrols" ID="txtRate" Enabled="False"></asp:TextBox>
                </div>
                <div class="col-sm-6 col-md-6" style="padding-right: 0px">
                    <asp:Label runat="server" Text="Rate"></asp:Label>
                    <asp:TextBox autocomplete="off" runat="server" CssClass="aspxcontrols" data-toggle="tooltip" data-placement="top" ID="txtAppRate" Enabled="False"></asp:TextBox>
            ...
            <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
                ...
                <div class="col-sm-6 col-md-6" style="padding-right: 0px">
                    <asp:Label runat="server" Text="Freight Amount"></asp:Label>
            ...
            <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
                <div class="col-sm-6 col-md-6">
                    ...
                    <asp:DropDownList runat="server" AutoPostBack="true" CssClass="aspxcontrols" ID="ddlVat" Enabled="False"></asp:DropDownList>
                </div>
                <div class="col-sm-6 col-md-6" style="padding-right: 0px">
            ...
            <div class="col-sm-12 col-md-12 form-group" style="padding: 0px">
                <div class="col-sm-6 col-md-6">
                    ...
                    <asp:DropDownList runat="server" AutoPostBack="true" CssClass="aspxcontrols" ID="ddlCst" Enabled="False"></asp:DropDownList>
                </div>
                <div class="col-sm-6 col-md-6" style="padding-right: 0px">
