...
Partial Class Purchase_InwardMaster
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            If IsPostBack = False Then
                ...
                imgbtnReport.Visible = False : sEMPSave = "NO"
    ...
    Public Sub BindDetails(ByVal iPageIndex As Integer)
        ...
        Try
            dt = objDDM.LoadInwardOrder(sSession.AccessCode, sSession.AccessCodeID, sSession.YearID)
            dgDD.DataSource = dt
            dgDD.DataBind()
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
    ...
    Private Sub dgDD_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles dgDD.RowCommand
        ...
        Try
            ...
            If e.CommandName.Equals("Edit") Then
                ...
                Response.Redirect(String.Format("~/Purchase/InwardNote.aspx?AID={0}&sStrID={1}", oMasterID, 1), False)
            End If
    ...
    Private Sub imgbtnAdd_Click(sender As Object, e As ImageClickEventArgs) Handles imgbtnAdd.Click
        Try
            lblError.Text = ""
            Response.Redirect(String.Format("~/Purchase/InwardNote.aspx?DID={0}", ""), False)
        Catch ex As Exception
            lblError.Text = objErrorClass.GetErrorMessages(sSession.AccessCode, ex.Message)
    ...
    Private Sub lnkbtnExcel_Click(sender As Object, e As EventArgs) Handles lnkbtnExcel.Click
        ...
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rdlc/PurchaseMaster/rptInwardMaster.rdlc")
            ...
            Response.AddHeader("content-disposition", "attachment; filename=InwardMaster" + ".xls")
    ...
    Private Sub lnkbtnPDF_Click(sender As Object, e As EventArgs) Handles lnkbtnPDF.Click
        ...
        Try
            ...
            Response.AddHeader("content-disposition", "attachment; filename=InwardMaster" + ".pdf")
            Response.BinaryWrite(RptViewer)
            Response.Flush()
            Response.End()
        Catch ex As Exception
