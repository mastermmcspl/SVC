<%@ Page Title="" Language="VB" MasterPageFile="~/Purchase.master" AutoEventWireup="false" CodeFile="InvoiceMasterForm.aspx.vb" Inherits="Purchase_InvoiceMasterForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="col-sm-12 col-md-12" style="padding: 0px">
        <asp:GridView ID="dgInM" runat="server" AutoGenerateColumns="False" Width="100%" class="footable">
            <Columns>
                ...
                <asp:BoundField DataField="Supplier" HeaderText="Supplier" HeaderStyle-Width="30%"></asp:BoundField>
                <asp:BoundField DataField="SaleType" HeaderText="SaleType" HeaderStyle-Width="20%"></asp:BoundField>
                <asp:BoundField DataField="InvoiceStatus" HeaderText="Invoice with Mannual Bill Amount Status" HeaderStyle-Width="20%" Visible="false"></asp:BoundField>
