...
Public Class clsOralSalesHR
    ...
    Public Function GetAccessCode(ByVal sNameSpace As String, ByVal sAccessID As Integer)
        ...
        End Try
    End Function
    Public Function loadOralFormaDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iInvice As Integer) As DataTable
        Dim sSql As String = ""
        ...
        Try
            ...
            sSql = "" : sSql = "select SPOD_ID,SPOD_SOID,b.SPO_ID,b.SPO_OrderCode,b.SPO_PartyName,SPOD_HistoryID,e.Inv_Color,e.Inv_Size,e.INV_Description,e.INV_Description,
                                ...
                                join Inventory_Master d on a.SPOD_CommodityID=d.Inv_ID   
                                join Inventory_Master e on a.SPOD_ItemID=e.Inv_ID 
                                join Acc_General_master g on a.SPOD_UnitOfMeasurement=g.Mas_ID where SPOD_Status <> 'C' and SPOD_CompID=" & iCompID & " And b.SPO_ID= " & iInvice & " And b.SPO_OrderType='O' order by b.SPO_ID,a.SPOD_HistoryID"
        ...
        End Try
    End Function
    'Public Shared Function CalculateNetAmount(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal iInvice As Integer, ByVal dMRPRate As Double) As String
    '    Dim sSql As String = ""
    ...
    '    End Try
    'End Function
    'Public Shared Function CalculateDiscountAmt(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal iInvice As Integer, ByVal dMRPRate As Double) As String
    '    Dim sSql As String = ""
    '    Dim bCheck As Boolean
    '    Dim sRate As String = ""
    '    Dim sVat As String = "" : Dim sAmt As String = "" : Dim sVAtAmt As String = ""
    ...
    Public Function GetChargeAmount(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal iOrderID As Integer) As Double
        ...
        Dim dt As New DataTable
        Try
            sSql = "Select Sum(C_ChargeAmount) As C_ChargeAmount From Charges_Master Where C_CompID=" & iCompID & " And C_YearID=" & iYearID & " And C_OrderID=" & iOrderID & " "
            dt = objDBL.SQLExecuteDataSet(sNameSpace, sSql).Tables(0)
    ...
    Public Function GetCharges(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal iOrderID As Integer) As DataTable
        ...
        Dim dt As New DataTable
        Try
            sSql = "Select C_ChargeType As ChargeType,C_ChargeAmount As ChargeAmount From Charges_Master Where C_OrderID=" & iOrderID & " And C_CompID=" & iCompID & " And C_YearID=" & iYearID & " "
            dt = objDBL.SQLExecuteDataSet(sNameSpace, sSql).Tables(0)
            Return dt
        Catch ex As Exception
            Throw
