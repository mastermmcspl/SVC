...
Imports System.Data
Public Class ClsOralCounterMaster
    ...
    Public Function LoadSalesOrder(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer) As DataTable
        ...
        Try
            ...
            sSql = "Select * from Sales_ProForma_Order where SPO_OrderType='O' AND SPO_YearID=" & iYearID & " And SPO_CompID =" & iCompID & " "
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                For i = 0 To ds.Tables(0).Rows.Count - 1
                    ...
                    bCheck = objDBL.SQLCheckForRecord(sNameSpace, "Select * From Sales_Dispatch_Master Where SDM_OrderID=" & ds.Tables(0).Rows(i)("SPO_ID").ToString() & " And SDM_CompID=" & iCompID & " ")
                    If bCheck = True Then
                        dr("Status") = "Invoice Done"
                    Else
                        dr("Status") = "Waiting for Invoice"
                    End If
    ...
    Public Sub UpdateJEMasterStatus(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iMasId As Integer, ByVal sStatus As String, ByVal iUserID As Integer, ByVal sIPAddress As String, ByVal iYearID As Integer)
        ...
        Try
            ...
            End If
            sSql = sSql & " Where SPO_OrderType='O' AND SPo_CompID=" & iCompID & " And SPO_YearID=" & iYearID & " And SPO_ID = " & iMasId & ""
    ...
    Public Sub UpdateJEMasterStatusWhole(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal sSelectedStatus As String, ByVal sStatus As String, ByVal iUserID As Integer, ByVal sIPAddress As String)
        ...
        Try
            sSql = "" : sSql = "Select * From Sales_ProForma_Order Where SPO_OrderType='O' AND SPO_Status='" & sSelectedStatus & "' And SPO_CompID=" & iCompID & " And SPO_YearID=" & iYearID & " "
            ...
            If dtSales.Rows.Count > 0 Then
                For j = 0 To dtSales.Rows.Count - 1
                    ...
                    ElseIf sStatus = "A" Then
                        sSql = sSql & " SPO_Status='A' "
                    End If
                    sSql = sSql & " Where SPO_OrderType='O' AND SPO_CompID=" & iCompID & " And SPO_YearID=" & iYearID & " And SPO_ID = " & dtPurchase.Rows(j)("SPO_ID") & ""
                    objDBL.SQLExecuteNonQuery(sNameSpace, sSql)
                Next
            End If
