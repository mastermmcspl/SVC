...
Imports System.Data
Public Class clsPROFormaSalesOrder
    ...
    Private dSPOD_FETotalAmt As Double
    Private iSPOD_Currency As Integer
    Private dSPOD_CurrencyAmt As Double
    Private sSPOD_CurrencyTime As String
    ...
    Public Property SPOD_IGSTAmount() As Double
        ...
        End Set
    End Property
    Public Property SPOD_FETotalAmt() As Double
        Get
            Return (dSPOD_FETotalAmt)
        End Get
        Set(ByVal Value As Double)
            dSPOD_FETotalAmt = Value
        End Set
    End Property
    Public Property SPOD_Currency() As Integer
        Get
            Return (iSPOD_Currency)
        End Get
        Set(ByVal Value As Integer)
            iSPOD_Currency = Value
        End Set
    End Property
    Public Property SPOD_CurrencyAmt() As Double
        Get
            Return (dSPOD_CurrencyAmt)
        End Get
        Set(ByVal Value As Double)
            dSPOD_CurrencyAmt = Value
        End Set
    End Property
    Public Property SPOD_CurrencyTime() As String
        Get
            Return (sSPOD_CurrencyTime)
        End Get
        Set(ByVal Value As String)
            sSPOD_CurrencyTime = Value
        End Set
    End Property
    ...
    Public Function GetMRPAmount(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iItemID As Integer) As Integer
        ...
        End Try
    End Function
    Public Function SavePROFormaMaster(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal objProForma As clsPROFormaSalesOrder) As Array
        ...
        Try
            ...
            If dt.Rows.Count > 0 Then
                For i = 0 To dt.Rows.Count - 1
                    ...
                    If IsDBNull(dt.Rows(i)("SPOD_Currency")) = False Then
                        dRow("CCurrency") = objDBL.SQLExecuteScalar(sNameSpace, "Select (CUR_CODE + ' [' + CUR_CountryName + ']') as OperateOn from Currency_master where CUR_ID=" & dt.Rows(i)("SPOD_Currency") & "")
                    End If
                    If IsDBNull(dt.Rows(i)("SPOD_FETotalAmt")) = False Then
                        dRow("FETotalAmount") = dt.Rows(i)("SPOD_FETotalAmt")
                    End If
                    dtTab.Rows.Add(dRow)
                Next
            End If
    ...
    Public Function GetSearch(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal sSearch As String) As DataTable
        ...
        Try
            If sSearch <> "" Then
                bCheckO = objDBL.SQLCheckForRecord(sNameSpace, "Select * From Sales_Proforma_Order where SPO_DispatchFlag <> 1 And SPO_OrderType='S' And SPO_OrderCode ='" & sSearch & "' And SPO_CompID=" & iCompID & " and SPO_YearID =" & iYearID & "")
                If bCheckO = True Then
                    sSql = "Select SPO_ID,SPO_OrderCode From Sales_Proforma_Order where SPO_DispatchFlag <> 1 And SPO_OrderType='S' And SPO_OrderCode ='" & sSearch & "' And SPO_CompID=" & iCompID & " and SPO_YearID =" & iYearID & ""
                    dt = objDBL.SQLExecuteDataSet(sNameSpace, sSql).Tables(0)
                Else
    ...
    Public Function GetUnitInDetailsTable(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iOrderID As Integer, ByVal iCommodityID As Integer, ByVal iItemID As Integer) As Integer
        ...
        End Try
    End Function
    Public Function GetCommodity(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iOrderID As Integer, ByVal iItemID As Integer, ByVal iPKID As Integer) As Integer
        Dim sSql As String = ""
        Dim dt As New DataTable
        Dim bCheck As Boolean
        Dim iCommodity As Integer
        Try
            bCheck = objDBL.SQLCheckForRecord(sNameSpace, "Select * From Sales_Proforma_Order_Details Where SPOD_ID=" & iPKID & " And SPOD_ItemID=" & iItemID & " And SPOD_SOID=" & iOrderID & " And SPOD_CompID=" & iCompID & "")
            If bCheck = True Then
                sSql = "Select SPOD_CommodityID From Sales_Proforma_Order_Details Where SPOD_ID=" & iPKID & " And SPOD_ItemID=" & iItemID & " And SPOD_SOID=" & iOrderID & " And SPOD_CompID=" & iCompID & " "
        ...
        End Try
    End Function
    Public Function LoadItems(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal iCommodityID As Integer, ByVal iBranch As Integer) As DataTable
        Dim dt As New DataTable
        Dim sSql As String = ""
        Try
            If iCommodityID > 0 Then
                ...
                sSql = "Select INV_ID,INV_Code From Inventory_Master Where INV_ID in(Select SL_ItemID From Stock_Ledger Where SL_CompID=" & iCompID & " and SL_Commodity =" & iCommodityID & " And SL_Branch=" & iBranch & ") and INV_Code <> '' order by Inv_Code"
            Else
                ...
                sSql = "Select INV_ID,INV_Code From Inventory_Master Where INV_ID in(Select SL_ItemID From Stock_Ledger Where SL_CompID=" & iCompID & " And SL_Branch=" & iBranch & ") and INV_Code <> '' order by Inv_Code"
            End If
            dt = objDBL.SQLExecuteDataSet(sNameSpace, sSql).Tables(0)
            Return dt
        Catch ex As Exception
    ...
    Public Function SavePROFormaMasterDetails(ByVal sNameSpace As String, ByVal objProForma As clsPROFormaSalesOrder, ByVal iYearID As Integer) As Array
        ...
        Try
            ...
            ObjParam(iParamCount) = New OleDb.OleDbParameter("@SPOD_FETotalAmt", OleDb.OleDbType.Double, 50)
            ObjParam(iParamCount).Value = objProForma.SPOD_FETotalAmt
            ObjParam(iParamCount).Direction = ParameterDirection.Input
            iParamCount += 1

            ObjParam(iParamCount) = New OleDb.OleDbParameter("@SPOD_Currency", OleDb.OleDbType.Integer, 4)
            ObjParam(iParamCount).Value = objProForma.SPOD_Currency
            ObjParam(iParamCount).Direction = ParameterDirection.Input
            iParamCount += 1

            ObjParam(iParamCount) = New OleDb.OleDbParameter("@SPOD_CurrencyAmt", OleDb.OleDbType.Double, 50)
            ObjParam(iParamCount).Value = objProForma.SPOD_CurrencyAmt
            ObjParam(iParamCount).Direction = ParameterDirection.Input
            iParamCount += 1

            ObjParam(iParamCount) = New OleDb.OleDbParameter("@SPOD_CurrencyTime", OleDb.OleDbType.VarChar, 50)
            ObjParam(iParamCount).Value = objProForma.SPOD_CurrencyTime
            ObjParam(iParamCount).Direction = ParameterDirection.Input
            iParamCount += 1
    ...
    Public Function GetCurrency(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iTRID As Integer) As Integer
        Dim sSql As String = ""
        Try
            sSql = "Select SPOD_Currency From Sales_Proforma_Order_Details Where SPOD_SOID=" & iTRID & " And SPOD_CompID =" & iCompID & ""
            Return objDBL.SQLExecuteScalarInt(sNameSpace, sSql)
        Catch ex As Exception
            Throw
        End Try
