...
Public Class clsReceipt
    ...
    Private Acc_RM_TrTypeDetails As Integer
    ...
    Private Acc_RM_BatchNo As Integer
    Private Acc_RM_BaseName As Integer
    ...
    Public Property iAcc_RM_BatchNo() As Integer
        Get
            Return (Acc_RM_BatchNo)
        End Get
        Set(ByVal Value As Integer)
            Acc_RM_BatchNo = Value
        End Set
    End Property
    Public Property iAcc_RM_BaseName() As Integer
        Get
            Return (Acc_RM_BaseName)
        End Get
        Set(ByVal Value As Integer)
            Acc_RM_BaseName = Value
        End Set
    End Property
    ...
    Public Property iAcc_RM_CreatedBy() As Integer
        ...
        End Set
    End Property
    Public Property iAcc_RM_TrTypeDetails() As Integer
        Get
            Return (Acc_RM_TrTypeDetails)
        End Get
        Set(ByVal Value As Integer)
            Acc_RM_TrTypeDetails = Value
        End Set
    End Property
    ...
    Public Function LoadReceiptDashboard(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iStatus As Integer, ByVal iYearID As Integer) As DataTable
        Dim dt As New DataTable
        ...
        Try
            ...
            sSql = "" : sSql = "Select * from Acc_Receipt_Master where ACC_RM_YearID=" & iYearID & " And Acc_RM_CompID =" & iCompID & " "
            If iStatus = 0 Then
    ...
    'Public Sub UpdateReceiptStatus(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iMasId As Integer, ByVal sStatus As String, ByVal iUserID As Integer, ByVal sIPAddress As String, ByVal iyearID As Integer)
    '    Dim sSql As String = ""
    '    Dim dt As New DataTable
    '    Try
    ...
    Public Function GenerateTransactionNo(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer) As String
        ...
        Dim ds As New DataSet
        Try
            iMax = objDBL.SQLExecuteScalar(sNameSpace, "Select isnull(Count(Acc_RM_ID)+1,1) from Acc_Receipt_Master Where Acc_RM_YearID=" & iYearID & " And Acc_RM_CompID=" & iCompID & " ")
    ...
    Public Function LoadBIllType(ByVal sNameSpace As String, ByVal iCompID As Integer) As DataTable
        ...
        End Try
    End Function
    Public Function SaveReceiptMaster(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal objRecp As clsReceipt)
        ...
        Try
            ...
            ObjParam(iParamCount) = New OleDb.OleDbParameter("@Acc_RM_TrTypeDetails", OleDb.OleDbType.Integer, 2)
            ObjParam(iParamCount).Value = objRecp.iAcc_RM_TrTypeDetails
            ObjParam(iParamCount).Direction = ParameterDirection.Input
            iParamCount += 1
        ...
        End Try
    End Function
    Public Function SaveTransactionsDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal objRecp As clsReceipt)
        ...
        Try
            ...
            ObjParam(iParamCount).Value = objRecp.sATD_Status
            ObjParam(iParamCount).Direction = ParameterDirection.Input
            iParamCount += 1
            ...
            ObjParam(iParamCount).Value = sATD_Operation
            ObjParam(iParamCount).Direction = ParameterDirection.Input
            iParamCount += 1
    ...
    Public Function GetReceiptDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iReceiptID As Integer) As DataTable
        Dim sSql As String = ""
        Dim dt As New DataTable
        Try
    ...
    '        dtDetails = objDBL.SQLExecuteDataSet(sNameSpace, "Select * From Acc_Transactions_Details Where ATD_Status='A' And ATD_TrType=3 And ATD_BillID=" & iMasId & " And ATD_CompID=" & iCompID & " And ATD_YearID=" & iYearID & " ").Tables(0)
    ...
    '                    sSql = sSql & " Where A.ATD_Status='A' And A.ATD_TrType=3 And A.ATD_BillID=" & iMasId & " And A.ATD_Head=" & iTrAccHead & " And A.ATD_SubGL=" & iTrGLID & " And A.ATD_CompID=" & iCompID & " And A.ATD_YearID=" & iYearID & " And C.ALM_Head=" & iTrHead & ""
    ...
    '                    sSql = sSql & " Where A.ATD_Status='A' And A.ATD_TrType=3 And A.ATD_BillID=" & iMasId & " And A.ATD_Head=" & iTrAccHead & " And A.ATD_GL=" & iTrGLID & " And A.ATD_CompID=" & iCompID & " And A.ATD_YearID=" & iYearID & " And C.ALM_Head=" & iTrHead & " "
    '                    dtValues = objDBL.SQLExecuteDataSet(sNameSpace, sSql).Tables(0)
    '                End If
    ...
    Public Function WriteGLTable(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iMasID As Integer, ByVal iyearID As Integer, ByVal iUserID As Integer)
        ...
        Dim iMaxID As Integer
        Try
            sSql = "" : sSql = "Select * From Acc_Transactions_Details Where ATD_Status='A' And ATD_TrType=3 And ATD_BillID=" & iMasID & " And ATD_YearID=" & iyearID & " And ATD_CompID=" & iCompID & " "
            dt = objDBL.SQLExecuteDataSet(sNameSpace, sSql).Tables(0)
            If dt.Rows.Count > 0 Then
                For i = 0 To dt.Rows.Count - 1
    ...
    Public Function GetSum(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal sJEID As String) As Double
        ...
        Try
            sSql = "Select Acc_SJE_InvoiceID from Acc_Sales_JE_Master where Acc_SJE_BillNo IN('" & sJEID & "') And Acc_SJE_CompID=" & iCompID & ""
            dtTable = objDBL.SQLExecuteDataTable(sNameSpace, sSql)
            If dtTable.Rows.Count > 0 Then
                For i = 0 To dtTable.Rows.Count - 1
                    If IsDBNull(dtTable.Rows(i)("Acc_SJE_InvoiceID").ToString()) = False Then
                        sIDs = sIDs & "," & dtTable.Rows(i)("Acc_SJE_InvoiceID").ToString()
                    End If
                Next
            End If
            ...
            End If
            sSql = "Select SUM(SDD_FETotalAmt) from Sales_Dispatch_Details where SDD_MasterID IN (" & sIDs & ") And SDD_CompID=" & iCompID & ""
            Return objDBL.SQLExecuteScalar(sNameSpace, sSql)
        Catch ex As Exception
            Throw
        End Try
    ...
    Public Function GetCurrency(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal sJEID As String, ByVal iCurrency As Integer) As Integer
        ...
        Try
            sSql = "Select Acc_SJE_InvoiceID from Acc_Sales_JE_Master where Acc_SJE_ID IN(" & sJEID & ") And Acc_SJE_CompID=" & iCompID & ""
            dtTable = objDBL.SQLExecuteDataTable(sNameSpace, sSql)
            If dtTable.Rows.Count > 0 Then
                For i = 0 To dtTable.Rows.Count - 1
                    If IsDBNull(dtTable.Rows(i)("Acc_SJE_InvoiceID").ToString()) = False Then
            ...
            If sIDs.StartsWith(",") Then
                sIDs = sIDs.Remove(0, 1)
            End If
            sSql = "Select Distinct(SDD_Currency) from Sales_Dispatch_Details where SDD_MasterID IN (" & sIDs & ") And SDD_CompID=" & iCompID & ""
            dt = objDBL.SQLExecuteDataTable(sNameSpace, sSql)
            If dt.Rows.Count > 0 Then
                For i = 0 To dt.Rows.Count - 1
                    If dt.Rows(i)("SDD_Currency").ToString() = "" Then
                        Return 0
                    Else
                        If dt.Rows(i)("SDD_Currency") = iCurrency Then
                            iCount = iCount + 1
                        Else
                            Return 0
                        End If
