...
Public Class ClsPO
    ...
    Private sPOM_BuyerRefNo As String
    ...
    Public Property POM_BaseName() As Integer
        ...
        End Set
    End Property
    Public Property POM_BuyerRefNo() As String
        Get
            Return (sPOM_BuyerRefNo)
        End Get
        Set(ByVal Value As String)
            sPOM_BuyerRefNo = Value
        End Set
    End Property
    ...
    Public Function LoadAllPurchaseDetails(ByVal sAC As String, ByVal iACID As Integer) As DataTable
        ...
        Try
            ...
            sSql = "SELECT POM_ID,POM_OrderDate,POM_OrderNo,POM_Supplier,POM_Status,POM_DelFlag,POM_TotAmount FROM PURCHASE_ORDER_MASTER where POM_OralStatus='P'"
    ...
    Public Function LoadExistingOrder(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer) As DataTable
        ...
        End Try
    End Function
    Public Function SavePurchaseOrder(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal dOrderDate As Date, ByVal objPO As ClsPO) As Integer
        Dim sSql As String = ""
        Dim dt As New DataTable
        Dim iMax As Integer = 0
        Try
            sSql = "" : sSql = "Select * from Purchase_Order_Master where POM_DcNo='" & objPO.sPOM_BuyerRefNo & "' And POM_OrderNo = '" & objPO.sPOM_OrderNo & "' and POM_CompID =" & iCompID & " and POM_YearID =" & objPO.iPOM_YearID & ""
            dt = objDB.SQLExecuteDataTable(sNameSpace, sSql)
            If dt.Rows.Count > 0 Then
                ...
                sSql = sSql & " Where POM_DcNo='" & objPO.sPOM_BuyerRefNo & "' And POM_OrderNo = '" & objPO.sPOM_OrderNo & "' and POM_CompID =" & iCompID & " and POM_YearID=" & objPO.iPOM_YearID & ""
            ...
            Else
                ...
                sSql = sSql & "POM_CompanyType,POM_GSTNCategory,POM_ZoneID,POM_RegionID,POM_AreaID,POM_BranchID,POM_BatchNo,POM_BaseName,POM_DcNo) "
                ...
                sSql = sSql & " " & objPO.iPOM_ZoneID & "," & objPO.iPOM_RegionID & "," & objPO.iPOM_AreaID & "," & objPO.iPOM_BranchID & "," & objPO.iPOM_BatchNo & "," & objPO.iPOM_BaseName & ",'" & objPO.sPOM_BuyerRefNo & "')"
                objDB.SQLExecuteNonQuery(sNameSpace, sSql)
                Return iMax
            End If
        Catch ex As Exception
    ...
    Public Function CheckApprovedOrNot(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal OrderNo As Integer) As Boolean
        ...
        End Try
    End Function
    Public Function SavePurchaseOrderDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal dRequiredDate As Date, ByVal objPO As ClsPO) As Integer
        Dim sSql As String = ""
        Dim dt As New DataTable
        Dim iMax As Integer = 0
        Dim iID As Integer
        Try
            sSql = "" : sSql = "Select POD_ID from Purchase_Order_Details where POD_MasterID = " & objPO.iPOD_MasterID & " and POD_Commodity = " & objPO.iPOD_Commodity & " and "
            ...
            If iID > 0 Then
                ...
                sSql = sSql & " where POD_MasterID = " & objPO.iPOD_MasterID & " and POD_Commodity = " & objPO.iPOD_Commodity & " and POD_DescriptionID = " & objPO.iPOD_DescriptionID & " and "
            ...
            Else
                ...
                sSql = sSql & "POD_CSTAmount,POD_TotalAmount,POD_CompID,POD_Status,POD_Frieght,POD_FrieghtAmount,POD_GST_ID,POD_GSTRate,POD_GSTAmount,POD_SGST,POD_SGSTAmount,POD_CGST,POD_CGSTAmount,POD_IGST,POD_IGSTAmount)"
                ...
                sSql = sSql & "'" & objPO.sPOD_CSTAmount & "','" & objPO.sPOD_TotalAmount & "'," & iCompID & ",'W','" & objPO.sPOD_Frieght & "','" & objPO.sPOD_FrieghtAmount & "'," & objPO.iPOD_GST_ID & "," & objPO.sPOD_GSTRate & "," & objPO.sPOD_GSTAmount & "," & objPO.iPOD_SGST & "," & objPO.sPOD_SGSTAmount & "," & objPO.iPOD_CGST & "," & objPO.sPOD_CGSTAmount & "," & objPO.iPOD_IGST & "," & objPO.sPOD_IGSTAmount & ")"
                objDB.SQLExecuteNonQuery(sNameSpace, sSql)
                iID = 0
                Return iID
            End If
        ...
        End Try
    End Function
    Public Function LoadPurchaseORderDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal iMasterID As Integer, ByVal iBatchNo As Integer, ByVal iBasename As Integer) As DataTable
        Dim sSql As String = ""
        Dim dt As New DataTable
        Dim dRow As DataRow
        ...
        Try
            ...
            If iBatchNo > 0 And iBasename > 0 Then
                sSql = "Select * from Purchase_Order_Details where POD_MasterID in(Select POM_ID From Purchase_Order_Master Where POM_BatchNo =" & iBatchNo & " And POM_BaseName=" & iBasename & " and POM_YearID=" & iYearID & " And POM_CompID=" & iCompID & ") And POD_CompID=" & iCompID & " and  POD_Status='W' order by POD_ID"
            Else
        ...
        End Try
    End Function
    Public Sub DeleteOrderValues(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearId As Integer, ByVal OrderNo As String, ByVal DcritionID As Integer, ByVal HistoryID As Integer)
        Dim sSql As String = ""
        Try
    ...
    Public Function LoadPurchaseOderMasterDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal iPomID As Integer, ByVal iBatchNo As Integer, ByVal iBaseNameID As Integer)
        Dim sSql As String = ""
        Dim dt As New DataTable
        Try
            If iBatchNo > 0 And iBaseNameID > 0 Then
                sSql = "" : sSql = "Select * from Purchase_Order_Master where POM_BatchNo = " & iBatchNo & " And POM_BaseName=" & iBaseNameID & " and POM_CompID = " & iCompID & " and POM_YearID =" & iYearID & ""
                dt = objDB.SQLExecuteDataTable(sNameSpace, sSql)
            Else
    ...
    Public Function LoadPurchaseOderDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iMasterID As Integer, ByVal iCommodity As Integer, ByVal iDescriptionID As Integer, ByVal iHistoryID As Integer)
        ...
        Dim dt As New DataTable
        Try
            sSql = "" : sSql = "Select * from Purchase_Order_Details where POD_MasterID = " & iMasterID & " and POD_Commodity = " & iCommodity & " and "
    ...
    Public Function DeleteCharges(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal iOrderID As Integer) As DataTable
        ...
        End Try
    End Function
    Public Function SaveCharges(ByVal sNameSpace As String, ByVal objInvoiceForm As ClsPO)
    ...
    Public Function LoadChargeType(ByVal sNameSpace As String, ByVal iCompID As Integer) As DataTable
        ...
        End Try
    End Function
    Public Function BindChargeData(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal iOrderID As Integer, ByVal iInvoiceID As Integer, ByVal iGinID As Integer, ByVal iBatchNo As Integer, ByVal iBaseName As Integer) As DataTable
        Dim sSql As String = ""
        ...
        Try
            ...
            If iBatchNo > 0 And iBaseName > 0 Then
                sSql = "" : sSql = "Select * From Charges_Master,Purchase_Order_Master Where C_POrderID=POM_ID And C_PSType='P' And C_POrderID in (Select POM_ID From Purchase_Order_Master Where POM_BatchNo=" & iBatchNo & " And POM_BaseName=" & iBaseName & " And POM_YearID=" & iYearID & " And POM_CompID=" & iCompID & ") And C_CompID =" & iCompID & " And C_YearID =" & iYearID & " "
            Else
    ...
    Public Function LoadExciseUsingDate(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal Sdate As String, ByVal HistoriID As String) As String
        ...
        Try
            ...
            sSql = "Select top 1 MAS_Desc From Acc_General_Master Where MAS_ID In (Select IMT_Excise from Inventory_Master_TaxDetails A where A.IMT_MasterID=" & HistoriID & " And A.IMT_EffectiveVATFRom <= Convert(datetime,'" & objFAS.FormatDtForRDBMS(Sdate, "CT") & "')) "
    ...
    Public Function GetOpeningBalance(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal sColumn As String, ByVal iGlID As Integer) As Double
        ...
        End Try
    End Function
    Public Function CheckVoucherNo(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal sVoucherNo As String) As Boolean
        Dim sSql As String = ""
        Try
            sSql = "Select POM_DcNo From Purchase_Order_Master Where POM_YearID=" & iYearID & " And POM_CompID=" & iCompID & " And POM_DcNo='" & sVoucherNo & "' "
            CheckVoucherNo = objDB.DBCheckForRecord(sNameSpace, sSql)
