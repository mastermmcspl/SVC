...
Public Class ClsPay
    ...
    Private iAcc_PM_BatchNo As Integer
    Private iAcc_PM_BaseName As Integer
    ...
    Public Property sAcc_PM_CurrencyTime() As String
        ...
        End Set
    End Property
    Public Property Acc_PM_BatchNo() As Integer
        Get
            Return (iAcc_PM_BatchNo)
        End Get
        Set(ByVal Value As Integer)
            iAcc_PM_BatchNo = Value
        End Set
    End Property
    Public Property Acc_PM_BaseName() As Integer
        Get
            Return (iAcc_PM_BaseName)
        End Get
        Set(ByVal Value As Integer)
            iAcc_PM_BaseName = Value
        End Set
    End Property
    ...
    Public Function LoadPayment(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iStatus As Integer) As DataTable
        ...
        Try
            ...
            sSql = "Select * from Acc_Payment_Master where Acc_PM_CompID =" & iCompID & " "
            If iStatus = 0 Then
    ...
    Public Function CheckLedgerTable(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iMasId As Integer, ByVal iYearID As Integer, ByVal iUserID As Integer, ByVal sIPAddress As String)
        ...
        Try
            ...
            dtDetails = objDBL.SQLExecuteDataSet(sNameSpace, "Select * From Acc_Transactions_Details Where ATD_TrType=1 And ATD_BillID=" & iMasId & " And ATD_CompID=" & iCompID & " And ATD_YearID=" & iYearID & " ").Tables(0)
            If dtDetails.Rows.Count > 0 Then
                For j = 0 To dtDetails.Rows.Count - 1
                    ...
                    If dtDetails.Rows(j)("ATD_SubGL") > 0 Then
                        ...
                        sSql = sSql & " Where A.ATD_TrType=1 And A.ATD_BillID=" & iMasId & " And A.ATD_Head=" & iTrAccHead & " And A.ATD_SubGL=" & iTrGLID & " And A.ATD_CompID=" & iCompID & " And A.ATD_YearID=" & iYearID & " And C.ALM_Head=" & iTrHead & ""
                    ...
                    Else
                        ...
                        sSql = sSql & " Where A.ATD_TrType=1 And A.ATD_BillID=" & iMasId & " And A.ATD_Head=" & iTrAccHead & " And A.ATD_GL=" & iTrGLID & " And A.ATD_CompID=" & iCompID & " And A.ATD_YearID=" & iYearID & " And C.ALM_Head=" & iTrHead & " "
                        dtValues = objDBL.SQLExecuteDataSet(sNameSpace, sSql).Tables(0)
                    End If
    ...
    '                    dOpenDebit = objDBL.SQLExecuteScalar(sNameSpace, "Select Opn_DebitAmt From Acc_Opening_Balance Where Opn_AccHead=" & iTrAccHead & " And Opn_GLID=" & iTrGLID & " And Opn_CompID=" & iCompID & " And Opn_YearID=" & iYearID & " ")
    '                    dOpenCredit = objDBL.SQLExecuteScalar(sNameSpace, "Select Opn_CreditAmount From Acc_Opening_Balance Where Opn_AccHead=" & iTrAccHead & " And Opn_GLID=" & iTrGLID & " And Opn_CompID=" & iCompID & " And Opn_YearID=" & iYearID & " ")

    '                    dTransDebit = objDBL.SQLExecuteScalar(sNameSpace, "Select ATD_Debit From Acc_Transactions_Details Where ATD_TrType=1 And ATD_BillID=" & iMasId & " And ATD_Head=" & iTrAccHead & " And ATD_GL=" & iTrGLID & " And ATD_CompID=" & iCompID & " And ATD_YearID=" & iYearID & " ")
    '                    dTransCredit = objDBL.SQLExecuteScalar(sNameSpace, "Select ATD_Credit From Acc_Transactions_Details Where ATD_TrType=1 And ATD_BillID=" & iMasId & " And ATD_Head=" & iTrAccHead & " And ATD_GL=" & iTrGLID & " And ATD_CompID=" & iCompID & " And ATD_YearID=" & iYearID & " ")

    '                    dPreviousTransDebit = objDBL.SQLExecuteScalarInt(sNameSpace, "Select ALM_TrDebit From Acc_Ledger_Masters Where ALM_AccountType=" & iTrAccHead & " And ALM_Head=" & iTrHead & " And ALM_GL=" & iTrGLID & " And ALM_CompID=" & iCompID & " And ALM_Year=" & iYearID & " ")
    '                    dTotalTransDebit = dPreviousTransDebit + dTransDebit

    '                    dPreviousTransCredit = objDBL.SQLExecuteScalarInt(sNameSpace, "Select ALM_TrCredit From Acc_Ledger_Masters Where ALM_AccountType=" & iTrAccHead & " And ALM_Head=" & iTrHead & " And ALM_GL=" & iTrGLID & " And ALM_CompID=" & iCompID & " And ALM_Year=" & iYearID & " ")
    '                    dTotalTransCredit = dPreviousTransCredit + dTransCredit
    ...
    Public Function GenerateTransactionNo(ByVal sNameSpace As String, ByVal iCompID As Integer) As String
        ...
        Dim ds As New DataSet
        Try
            iMax = objDBL.SQLExecuteScalar(sNameSpace, "Select isnull(max(Acc_PM_ID)+1,1) from Acc_Payment_Master")
    ...
    Public Function DeleteTransactionsDetails(ByVal sNameSpace As String, ByVal iCompid As Integer, ByVal iTrans As Integer, ByVal iBillID As Integer)
        ...
        End Try
    End Function
    Public Function SavePaymentMaster(ByVal sAC As String, ByVal iCompID As Integer, ByVal iPaymentType As Integer, ByVal objPayment As ClsPay) As Array
    ...
    Public Function SaveTransactionDetails(ByVal sAC As String, ByVal iCompID As Integer, ByVal iPaymentType As Integer, ByVal objPayment As ClsPay) As Array
    ...
    Public Function GetPaymentDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iPaymentID As Integer, ByVal iBatchNo As Integer, ByVal iBaseName As Integer) As DataTable
        ...
        Try
            If iBatchNo > 0 And iBaseName > 0 Then
                sSql = "" : sSql = "Select * from Acc_Payment_Master where Acc_PM_BatchNo =" & iBatchNo & " And Acc_PM_BaseName=" & iBaseName & " And Acc_PM_CompID =" & iCompID & ""
                dt = objDBL.SQLExecuteDataTable(sNameSpace, sSql)
            Else
    ...
    Public Function GetDefaultBranch(ByVal sNameSpace As String, ByVal iCompID As Integer) As Integer
        ...
        End Try
    End Function
    Public Function getStatus(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal iPaymentID As Integer) As String
        Dim sSql As String = ""
        Try
            sSql = "Select Acc_PM_Status From Acc_Payment_Master Where Acc_PM_ID=" & iPaymentID & " And Acc_PM_CompID=" & iCompID & " And Acc_PM_YearID=" & iYearID & " "
