...
Public Class ClsJE
    ...
    Private iAcc_JE_BatchNo As Integer
    Private iAcc_JE_BaseName As Integer
    ...
    Public Property Acc_JE_BatchNo() As Integer
        Get
            Return (iAcc_JE_BatchNo)
        End Get
        Set(ByVal Value As Integer)
            iAcc_JE_BatchNo = Value
        End Set
    End Property
    Public Property Acc_JE_BaseName() As Integer
        Get
            Return (iAcc_JE_BaseName)
        End Get
        Set(ByVal Value As Integer)
            iAcc_JE_BaseName = Value
        End Set
    End Property
    ...
    Public Function LoadJournalEntry(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iStatus As Integer, ByVal iYearID As Integer) As DataTable
        ...
        Try
            ...
            sSql = "Select * from Acc_JE_Master where Acc_JE_CompID =" & iCompID & " "
            If iStatus = 0 Then
    ...
    Public Sub UpdateJEMasterStatus(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iMasId As Integer, ByVal sStatus As String, ByVal iUserID As Integer, ByVal sIPAddress As String)
        Dim sSql As String = ""
        Try
    ...
    Public Function SaveJournalMaster(ByVal sNameSpace As String, ByVal iCompID As Integer, objJE As ClsJE)
        ...
        Try
            ...
            ObjParam(iParamCount) = New OleDb.OleDbParameter("@ACC_JE_ZoneID", OleDb.OleDbType.Integer, 4)
            ObjParam(iParamCount).Value = objJE.iACC_JE_ZoneID
            ObjParam(iParamCount).Direction = ParameterDirection.Input
            iParamCount += 1

            ObjParam(iParamCount) = New OleDb.OleDbParameter("@ACC_JE_RegionID", OleDb.OleDbType.Integer, 4)
            ObjParam(iParamCount).Value = objJE.iACC_JE_RegionID
            ObjParam(iParamCount).Direction = ParameterDirection.Input
            iParamCount += 1

            ObjParam(iParamCount) = New OleDb.OleDbParameter("@ACC_JE_AreaID", OleDb.OleDbType.Integer, 4)
    ...
    Public Function SaveTransactionDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, objJE As ClsJE)
    ...
    Public Function GetPaymentTypeDetails(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iPaymentID As Integer, ByVal iBatchNo As Integer, ByVal iBaseName As Integer) As DataTable
        Dim sSql As String = ""
        Dim dt As New DataTable
        Try
            If iBatchNo > 0 And iBaseName > 0 Then
                sSql = "" : sSql = "Select * from Acc_JE_Master where Acc_JE_BatchNo =" & iBatchNo & " And Acc_JE_BaseName=" & iBaseName & " and Acc_JE_CompID =" & iCompID & ""
                dt = objDBL.SQLExecuteDataTable(sNameSpace, sSql)
            Else
    ...
    Public Function UpdatePaymentMaster(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iPaymentType As Integer, ByVal objJE As ClsJE)
        Dim sSql As String = ""
        Dim dt As New DataTable
        Try
            sSql = "" : sSql = "Select * from acc_JE_Master where Acc_JE_ID =" & objJE.iAcc_JE_ID & " and Acc_JE_CompID =" & iCompID & ""
    ...
    Public Function CheckLedgerTable(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iMasId As Integer, ByVal iYearID As Integer, ByVal iUserID As Integer, ByVal sIPAddress As String)
        ...
        Try
            ...
            dtDetails = objDBL.SQLExecuteDataSet(sNameSpace, "Select * From Acc_Transactions_Details Where ATD_TrType=4 And ATD_BillID=" & iMasId & " And ATD_CompID=" & iCompID & " And ATD_YearID=" & iYearID & " ").Tables(0)
            If dtDetails.Rows.Count > 0 Then
                For j = 0 To dtDetails.Rows.Count - 1
                    ...
                    If dtDetails.Rows(j)("ATD_SubGL") > 0 Then
                        ...
                        sSql = sSql & " Where A.ATD_TrType=4 And A.ATD_BillID=" & iMasId & " And A.ATD_Head=" & iTrAccHead & " And A.ATD_SubGL=" & iTrGLID & " And A.ATD_CompID=" & iCompID & " And A.ATD_YearID=" & iYearID & " And C.ALM_Head=" & iTrHead & ""
                    ...
                    Else
                        ...
                        sSql = sSql & " Where A.ATD_TrType=4 And A.ATD_BillID=" & iMasId & " And A.ATD_Head=" & iTrAccHead & " And A.ATD_GL=" & iTrGLID & " And A.ATD_CompID=" & iCompID & " And A.ATD_YearID=" & iYearID & " And C.ALM_Head=" & iTrHead & " "
                        dtValues = objDBL.SQLExecuteDataSet(sNameSpace, sSql).Tables(0)
                    End If
    ...
    Public Function GetBaseID(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal iCabinet As Integer, ByVal iSubCabinet As Integer, ByVal iFolder As Integer) As DataTable
        ...
        End Try
    End Function
    Public Function LoadSavedTransactionDetailsJE(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iYearID As Integer, ByVal iPaymentID As Integer) As DataTable
        Dim dt As New DataTable
        Dim ds As New DataSet
        Dim dc As New DataColumn
        Dim sSql As String = "", aSql As String = ""
        ...
        Try
            ...
            sSql = sSql & "A.ATD_Credit,B.gl_glCode as GlCode, B.gl_Desc as GlDescription, C.gl_glCode as SubGlCode, c.Gl_Desc as SubGlDesc "
            sSql = sSql & "from Acc_Transactions_Details A join chart_of_Accounts B on "
            sSql = sSql & "A.ATD_BillId = " & iPaymentID & " and A.ATD_TRType = 4 and A.ATD_GL = B.gl_ID Left join chart_of_Accounts C on "
    ...
    Public Function LoadExistingTrnNo(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal sTrNo As Integer) As DataTable
        ...
        Dim dt As New DataTable
        Try
            sSql = "select Acc_JE_ID,Acc_JE_TransactionNo from Acc_JE_Master where Acc_JE_ID=" & sTrNo & " and Acc_JE_CompID=" & iCompID & " "
            dt = objDBL.SQLExecuteDataTable(sNameSpace, sSql)
            Return dt
        Catch ex As Exception
            Throw
    ...
    Public Function getStatus(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iMasId As Integer)
        ...
        Dim iID As String
        Try
            sSql = "select Acc_JE_Status from Acc_JE_Master where Acc_JE_ID=" & iMasId & ""
    ...
    Public Sub UpdateJEMasterStatus1(ByVal sNameSpace As String, ByVal iCompID As Integer, ByVal iMasId As Integer, ByVal sStatus As String, ByVal iUserID As Integer, ByVal sIPAddress As String, ByVal iyearID As Integer)
        Dim sSql As String = ""
        Dim dt As New DataTable
        Try
            sSql = "Update Acc_JE_Master Set Acc_JE_IPAddress='" & sIPAddress & "',"
